...
public class POSTDistributionItemType   {
  ...
  public POSTDistributionItemType accountingPeriodName(String accountingPeriodName) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Name of the accounting period. The open-ended accounting period is named `Open-Ended`.   The accounting period must be open. ")
  ...
  public POSTDistributionItemType newAmount(String newAmount) {
   ...
   * @return newAmount
  **/
  @ApiModelProperty(example = "null", required = true, value = "Amount of revenue you want to distribute into the accounting period.  The value must be formatted based on the currency, for example, `JPY 30` or `USD 30.15`. If the value is formatted incorrectly, the following error message is returned: `Allocation amount with wrong decimal places.` ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTDistributionItemType pOSTDistributionItemType = (POSTDistributionItemType) o;
    return Objects.equals(this.accountingPeriodName, pOSTDistributionItemType.accountingPeriodName) &&
        Objects.equals(this.newAmount, pOSTDistributionItemType.newAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountingPeriodName, newAmount);
  }

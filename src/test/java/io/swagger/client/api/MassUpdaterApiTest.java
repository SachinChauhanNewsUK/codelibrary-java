...
/**
 * API tests for MassUpdaterApi
 */
public class MassUpdaterApiTest {

    private final MassUpdaterApi api = new MassUpdaterApi();
     ...
     */
    @Test
    public void gETMassUpdateTest() throws ApiException {
        String bulkKey = null;
        // GETMassUpdateType response = api.gETMassUpdate(bulkKey);
     ...
     */
    @Test
    public void pOSTMassUpdateTest() throws ApiException {
        String contentType = null;
        POSTMassUpdateType request = null;
        // POSTMassUpdateResponseType response = api.pOSTMassUpdate(contentType, request);
     ...
     */
    @Test
    public void pUTMassUpdaterTest() throws ApiException {
        String bulkKey = null;
        // CommonResponseType response = api.pUTMassUpdater(bulkKey);

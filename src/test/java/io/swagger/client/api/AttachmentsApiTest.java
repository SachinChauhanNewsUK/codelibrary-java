...
public class AttachmentsApiTest {
     ...
     */
    @Test
    public void dELETEAttachmentsTest() throws ApiException {
        String attachmentId = null;
        // CommonResponseType response = api.dELETEAttachments(attachmentId);
    ...
    public void gETAttachmentsTest() throws ApiException {
        String attachmentId = null;
        // GETAttachmentResponseType response = api.gETAttachments(attachmentId);
     ...
     */
    @Test
    public void gETAttachmentsResponseTest() throws ApiException {
        String objectType = null;
        String objectKey = null;
        // GETAttachmentsResponseType response = api.gETAttachmentsResponse(objectType, objectKey);
     ...
     */
    @Test
    public void pOSTAttachmentsTest() throws ApiException {
        String associatedObjectType = null;
        String associatedObjectKey = null;
        POSTAttachmentType request = null;
        String description = null;
        // POSTAttachmentResponseType response = api.pOSTAttachments(associatedObjectType, associatedObjectKey, request, description);
     ...
     */
    @Test
    public void pUTAttachmentsTest() throws ApiException {
        String attachmentId = null;
        PUTAttachmentType request = null;
        // CommonResponseType response = api.pUTAttachments(attachmentId, request);

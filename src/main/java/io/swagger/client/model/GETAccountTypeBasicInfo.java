...
public class GETAccountTypeBasicInfo   {
  ...
  public GETAccountTypeBasicInfo accountNumber(String accountNumber) {
  ...
  **/
  ...
  public GETAccountTypeBasicInfo batch(String batch) {
    this.batch = batch;
    return this;
  }
  ...
  **/
  ...
  public GETAccountTypeBasicInfo communicationProfileId(String communicationProfileId) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "ID of a [communication profile](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Communication_Profile). ")
  ...
  public GETAccountTypeBasicInfo crmId(String crmId) {
    this.crmId = crmId;
    return this;
  }
   ...
   * @return crmId
  **/
  @ApiModelProperty(example = "null", value = "CRM account ID for the account, 100 characters or less. ")
  ...
  public GETAccountTypeBasicInfo customFieldC(String customFieldC) {
  ...
  **/
  ...
  public GETAccountTypeBasicInfo id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public GETAccountTypeBasicInfo invoiceTemplateId(String invoiceTemplateId) {
  ...
  **/
  ...
  public GETAccountTypeBasicInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GETAccountTypeBasicInfo notes(String notes) {
    this.notes = notes;
    return this;
  }
   ...
   * @return notes
  **/
  @ApiModelProperty(example = "null", value = "Notes associated with the account, up to 65,535 characters. ")
  ...
  public GETAccountTypeBasicInfo status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public GETAccountTypeBasicInfo tags(String tags) {
    this.tags = tags;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GETAccountTypeBasicInfo gETAccountTypeBasicInfo = (GETAccountTypeBasicInfo) o;
    return Objects.equals(this.accountNumber, gETAccountTypeBasicInfo.accountNumber) &&
        Objects.equals(this.batch, gETAccountTypeBasicInfo.batch) &&
        Objects.equals(this.communicationProfileId, gETAccountTypeBasicInfo.communicationProfileId) &&
        Objects.equals(this.crmId, gETAccountTypeBasicInfo.crmId) &&
        Objects.equals(this.customFieldC, gETAccountTypeBasicInfo.customFieldC) &&
        Objects.equals(this.id, gETAccountTypeBasicInfo.id) &&
        Objects.equals(this.invoiceTemplateId, gETAccountTypeBasicInfo.invoiceTemplateId) &&
        Objects.equals(this.name, gETAccountTypeBasicInfo.name) &&
        Objects.equals(this.notes, gETAccountTypeBasicInfo.notes) &&
        Objects.equals(this.status, gETAccountTypeBasicInfo.status) &&
        Objects.equals(this.tags, gETAccountTypeBasicInfo.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, batch, communicationProfileId, crmId, customFieldC, id, invoiceTemplateId, name, notes, status, tags);
  }

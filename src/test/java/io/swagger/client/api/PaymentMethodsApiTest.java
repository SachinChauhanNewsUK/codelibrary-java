...
public class PaymentMethodsApiTest {
     ...
     */
    @Test
    public void dELETEPaymentMethodsTest() throws ApiException {
        String paymentMethodId = null;
        // CommonResponseType response = api.dELETEPaymentMethods(paymentMethodId);
    ...
    public void gETPaymentMethodsTest() throws ApiException {
        ...
        // GETPaymentMethodsType response = api.gETPaymentMethods(accountKey);
     ...
     */
    @Test
    public void pOSTPaymentMethodTest() throws ApiException {
        POSTPaymentMethodType request = null;
        // POSTPaymentMethodResponseType response = api.pOSTPaymentMethod(request);
     ...
     */
    @Test
    public void pUTPaymentMethodsTest() throws ApiException {
        String paymentMethodId = null;
        PUTPaymentMethodType request = null;
        // PUTPaymentMethodResponseType response = api.pUTPaymentMethods(paymentMethodId, request);
     ...
     */
    @Test
    public void proxyDELETEPaymentMethodTest() throws ApiException {
        String id = null;
        // ProxyDeleteResponse response = api.proxyDELETEPaymentMethod(id);
     ...
     */
    @Test
    public void proxyGETPaymentMethodTest() throws ApiException {
        String id = null;
        String fields = null;
        // ProxyGetPaymentMethod response = api.proxyGETPaymentMethod(id, fields);
     ...
     */
    @Test
    public void proxyPOSTPaymentMethodTest() throws ApiException {
        ProxyCreatePaymentMethod createRequest = null;
        // ProxyCreateOrModifyResponse response = api.proxyPOSTPaymentMethod(createRequest);
     ...
     */
    @Test
    public void proxyPUTPaymentMethodTest() throws ApiException {
        String id = null;
        ProxyModifyPaymentMethod modifyRequest = null;
        // ProxyCreateOrModifyResponse response = api.proxyPUTPaymentMethod(id, modifyRequest);

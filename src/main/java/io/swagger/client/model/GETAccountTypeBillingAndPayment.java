 ...
 */
@ApiModel(description = "Container for billing and payment information for the account. ")
...
public class GETAccountTypeBillingAndPayment   {
  ...
  public GETAccountTypeBillingAndPayment billCycleDay(String billCycleDay) {
  ...
  **/
  ...
  public GETAccountTypeBillingAndPayment currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(example = "null", value = "A currency defined in the [administrative web-based UI](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Customize_Currencies). ")
  ...
  public GETAccountTypeBillingAndPayment paymentGateway(String paymentGateway) {
  ...
  **/
  ...
  public GETAccountTypeBillingAndPayment paymentTerm(String paymentTerm) {
   ...
   * @return paymentTerm
  **/
  @ApiModelProperty(example = "null", value = "A payment-terms indicator defined in the [web-based UI administrative settings](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Payment_Terms), e.g., \"Net 30\". ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GETAccountTypeBillingAndPayment gETAccountTypeBillingAndPayment = (GETAccountTypeBillingAndPayment) o;
    return Objects.equals(this.billCycleDay, gETAccountTypeBillingAndPayment.billCycleDay) &&
        Objects.equals(this.currency, gETAccountTypeBillingAndPayment.currency) &&
        Objects.equals(this.paymentGateway, gETAccountTypeBillingAndPayment.paymentGateway) &&
        Objects.equals(this.paymentTerm, gETAccountTypeBillingAndPayment.paymentTerm);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billCycleDay, currency, paymentGateway, paymentTerm);
  }

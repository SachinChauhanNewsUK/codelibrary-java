...
import io.swagger.client.model.POSTMassUpdateTypeParams;
...
public class POSTMassUpdateType   {
  ...
  private POSTMassUpdateTypeParams params = null;

  public POSTMassUpdateType file(String file) {
    this.file = file;
    return this;
  }
   ...
   * @return file
  **/
  @ApiModelProperty(example = "null", required = true, value = "File containing data about the mass action you want to perform. The file requirements are the same as when uploading a file through the Mass Updater on the Zuora UI.  The file must be a .csv file or a zipped .csv file.   The maximum file size is 4 MB.  The data in the file must be formatted according to the mass action type you want to perform. Refer to the articles listed in the `actionType` field below for the requirements of each mass action type.  See the [Uploaded File](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater#Uploaded_File) section of the Mass Updater article for more information about the upload file. ")
  ...
  public POSTMassUpdateType params(POSTMassUpdateTypeParams params) {
    this.params = params;
    return this;
  }
  ...
  **/
  ...
  public POSTMassUpdateTypeParams getParams() {
    return params;
  }

  public void setParams(POSTMassUpdateTypeParams params) {
    this.params = params;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTMassUpdateType pOSTMassUpdateType = (POSTMassUpdateType) o;
    return Objects.equals(this.file, pOSTMassUpdateType.file) &&
        Objects.equals(this.params, pOSTMassUpdateType.params);
  }

  @Override
  public int hashCode() {
    return Objects.hash(file, params);
  }

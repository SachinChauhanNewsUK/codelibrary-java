...
public class PUTAccountingCodeType   {
  ...
  public PUTAccountingCodeType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public PUTAccountingCodeType glAccountName(String glAccountName) {
  ...
  **/
  ...
  public PUTAccountingCodeType glAccountNumber(String glAccountNumber) {
  ...
  **/
  ...
  public PUTAccountingCodeType name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "Name of the accounting code.  Accounting code name must be unique. Maximum of 100 characters. ")
  ...
  public PUTAccountingCodeType notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  **/
  ...
  public PUTAccountingCodeType type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "Accounting code type.   Valid values are as follows: * `AccountsReceivable` * `Cash` * `OtherAssets` * `CustomerCashOnAccount` * `DeferredRevenue` * `SalesTaxPayable` * `OtherLiabilities` * `SalesRevenue` * `SalesDiscounts` * `OtherRevenue` * `OtherEquity` * `BadDebt` * `OtherExpenses`            You cannot change the type of an accounting code from `AccountsReceivable` to a different type. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTAccountingCodeType pUTAccountingCodeType = (PUTAccountingCodeType) o;
    return Objects.equals(this.customFieldC, pUTAccountingCodeType.customFieldC) &&
        Objects.equals(this.glAccountName, pUTAccountingCodeType.glAccountName) &&
        Objects.equals(this.glAccountNumber, pUTAccountingCodeType.glAccountNumber) &&
        Objects.equals(this.name, pUTAccountingCodeType.name) &&
        Objects.equals(this.notes, pUTAccountingCodeType.notes) &&
        Objects.equals(this.type, pUTAccountingCodeType.type);
  }

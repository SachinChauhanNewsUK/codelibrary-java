...
import io.swagger.client.model.GatewayOptionData;
...
public class PaymentMethod   {
  ...
  private String creditCardSecurityCode = null;
  ...
  private GatewayOptionData gatewayOptionData = null;
  ...
  **/
  ...
  public PaymentMethod achAbaCode(String achAbaCode) {
  ...
  **/
  ...
  public PaymentMethod achAccountName(String achAccountName) {
  ...
  **/
  ...
  public PaymentMethod achAccountNumber(String achAccountNumber) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " The bank account number associated with the ACH payment. Use this field for ACH payment methods. **Character limit**: 30 **Values**: a string of 30 numeric characters or fewer ")
  ...
  public PaymentMethod achAccountNumberMask(String achAccountNumberMask) {
  ...
  **/
  ...
  public PaymentMethod achAccountType(String achAccountType) {
  ...
  **/
  ...
  public PaymentMethod achAddress1(String achAddress1) {
  ...
  **/
  ...
  public PaymentMethod achAddress2(String achAddress2) {
  ...
  **/
  ...
  public PaymentMethod achBankName(String achBankName) {
  ...
  **/
  ...
  public PaymentMethod bankBranchCode(String bankBranchCode) {
  ...
  **/
  ...
  public PaymentMethod bankCheckDigit(String bankCheckDigit) {
  ...
  **/
  ...
  public PaymentMethod bankCity(String bankCity) {
  ...
  **/
  ...
  public PaymentMethod bankCode(String bankCode) {
  ...
  **/
  ...
  public PaymentMethod bankPostalCode(String bankPostalCode) {
  ...
  **/
  ...
  public PaymentMethod bankStreetName(String bankStreetName) {
  ...
  **/
  ...
  public PaymentMethod bankStreetNumber(String bankStreetNumber) {
  ...
  **/
  ...
  public PaymentMethod bankTransferAccountName(String bankTransferAccountName) {
  ...
  **/
  ...
  public PaymentMethod bankTransferAccountNumber(String bankTransferAccountNumber) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " The number of the customer's bank account. Use this field for direct debit payment methods. **Character limit**:30 **Values**:  string of 30 characters or fewer ")
  ...
  public PaymentMethod bankTransferAccountNumberMask(String bankTransferAccountNumberMask) {
  ...
  **/
  ...
  public PaymentMethod bankTransferAccountType(String bankTransferAccountType) {
  ...
  **/
  ...
  public PaymentMethod bankTransferType(String bankTransferType) {
  ...
  **/
  ...
  public PaymentMethod businessIdentificationCode(String businessIdentificationCode) {
  ...
  **/
  ...
  public PaymentMethod city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public PaymentMethod createdById(String createdById) {
  ...
  **/
  ...
  public PaymentMethod createdDate(DateTime createdDate) {
  ...
  **/
  ...
  public PaymentMethod creditCardAddress1(String creditCardAddress1) {
  ...
  **/
  ...
  public PaymentMethod creditCardAddress2(String creditCardAddress2) {
  ...
  **/
  ...
  public PaymentMethod creditCardCity(String creditCardCity) {
  ...
  **/
  ...
  public PaymentMethod creditCardCountry(String creditCardCountry) {
  ...
  **/
  ...
  public PaymentMethod creditCardExpirationMonth(Integer creditCardExpirationMonth) {
  ...
  **/
  ...
  public PaymentMethod creditCardExpirationYear(Integer creditCardExpirationYear) {
  ...
  **/
  ...
  public PaymentMethod creditCardHolderName(String creditCardHolderName) {
  ...
  **/
  ...
  public PaymentMethod creditCardMaskNumber(String creditCardMaskNumber) {
  ...
  **/
  ...
  public PaymentMethod creditCardNumber(String creditCardNumber) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " The credit card or debit card number. This is an insert-only field; it cannot be updated nor queried for security purposes. This field is required only when you define a debit card or credit card payment. **Character limit**: 16 **Values**: a string of 16 characters or fewer ")
  ...
  public PaymentMethod creditCardPostalCode(String creditCardPostalCode) {
  ...
  **/
  ...
  public PaymentMethod creditCardSecurityCode(String creditCardSecurityCode) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " The CVV or CVV2 security code. See [How do I control what information Zuora sends over to the Payment Gateway?](https://knowledgecenter.zuora.com/kb/How_do_I_control_information_sent_to_payment_gateways_when_verifying_payment_methods%3F) for more information. To ensure PCI compliance, this value is not stored and cannot be queried. **Character limit**: **Values**: a valid CVV or CVV2 security code ")
  ...
  public PaymentMethod creditCardState(String creditCardState) {
  ...
  **/
  ...
  public PaymentMethod creditCardType(String creditCardType) {
  ...
  **/
  ...
  public PaymentMethod existingMandate(String existingMandate) {
  ...
  **/
  ...
  public PaymentMethod gatewayOptionData(GatewayOptionData gatewayOptionData) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Use this field to pass gateway options. **Character limit**: 255 **Values**: [GatewayOption](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Payment/Pass_Gateway_Parameters) ")
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = " The ID of this object. Upon creation, the ID of this object is `PaymentMethodId`. **Character limit**: 32 **Values**: automatically generated ")
  public String getId() {
    return id;
  }
  ...
  public PaymentMethod lastFailedSaleTransactionDate(DateTime lastFailedSaleTransactionDate) {
  ...
  **/
  ...
  public PaymentMethod lastTransactionDateTime(DateTime lastTransactionDateTime) {
  ...
  **/
  ...
  public PaymentMethod mandateCreationDate(LocalDate mandateCreationDate) {
  ...
  **/
  ...
  public PaymentMethod mandateID(String mandateID) {
  ...
  **/
  ...
  public PaymentMethod mandateReceived(String mandateReceived) {
  ...
  **/
  ...
  public PaymentMethod mandateUpdateDate(LocalDate mandateUpdateDate) {
  ...
  **/
  ...
  public PaymentMethod maxConsecutivePaymentFailures(Integer maxConsecutivePaymentFailures) {
  ...
  **/
  ...
  public PaymentMethod numConsecutiveFailures(Integer numConsecutiveFailures) {
  ...
  **/
  ...
  public PaymentMethod paymentMethodStatus(String paymentMethodStatus) {
  ...
  **/
  ...
  public PaymentMethod paymentRetryWindow(Integer paymentRetryWindow) {
  ...
  **/
  ...
  public PaymentMethod paypalBaid(String paypalBaid) {
  ...
  **/
  ...
  public PaymentMethod paypalEmail(String paypalEmail) {
  ...
  **/
  ...
  public PaymentMethod paypalPreapprovalKey(String paypalPreapprovalKey) {
  ...
  **/
  ...
  public PaymentMethod paypalType(String paypalType) {
  ...
  **/
  ...
  public PaymentMethod phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  **/
  ...
  public PaymentMethod secondTokenId(String secondTokenId) {
  ...
  **/
  ...
  public PaymentMethod skipValidation(Boolean skipValidation) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Creates the payment method even if authorization fails with the payment gateway. **Character limit**: 5 **Values**: `t``rue`, `false` ")
  ...
  **/
  ...
  public PaymentMethod streetName(String streetName) {
  ...
  **/
  ...
  public PaymentMethod streetNumber(String streetNumber) {
  ...
  **/
  ...
  public PaymentMethod tokenId(String tokenId) {
  ...
  **/
  ...
  public PaymentMethod updatedById(String updatedById) {
  ...
  **/
  ...
  public PaymentMethod updatedDate(DateTime updatedDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountId, paymentMethod.accountId) &&
        Objects.equals(this.achAbaCode, paymentMethod.achAbaCode) &&
        Objects.equals(this.achAccountName, paymentMethod.achAccountName) &&
        Objects.equals(this.achAccountNumber, paymentMethod.achAccountNumber) &&
        Objects.equals(this.achAccountNumberMask, paymentMethod.achAccountNumberMask) &&
        Objects.equals(this.achAccountType, paymentMethod.achAccountType) &&
        Objects.equals(this.achAddress1, paymentMethod.achAddress1) &&
        Objects.equals(this.achAddress2, paymentMethod.achAddress2) &&
        Objects.equals(this.achBankName, paymentMethod.achBankName) &&
        Objects.equals(this.active, paymentMethod.active) &&
        Objects.equals(this.bankBranchCode, paymentMethod.bankBranchCode) &&
        Objects.equals(this.bankCheckDigit, paymentMethod.bankCheckDigit) &&
        Objects.equals(this.bankCity, paymentMethod.bankCity) &&
        Objects.equals(this.bankCode, paymentMethod.bankCode) &&
        ...
        Objects.equals(this.bankPostalCode, paymentMethod.bankPostalCode) &&
        Objects.equals(this.bankStreetName, paymentMethod.bankStreetName) &&
        Objects.equals(this.bankStreetNumber, paymentMethod.bankStreetNumber) &&
        Objects.equals(this.bankTransferAccountName, paymentMethod.bankTransferAccountName) &&
        Objects.equals(this.bankTransferAccountNumber, paymentMethod.bankTransferAccountNumber) &&
        Objects.equals(this.bankTransferAccountNumberMask, paymentMethod.bankTransferAccountNumberMask) &&
        Objects.equals(this.bankTransferAccountType, paymentMethod.bankTransferAccountType) &&
        Objects.equals(this.bankTransferType, paymentMethod.bankTransferType) &&
        Objects.equals(this.businessIdentificationCode, paymentMethod.businessIdentificationCode) &&
        Objects.equals(this.city, paymentMethod.city) &&
        Objects.equals(this.country, paymentMethod.country) &&
        Objects.equals(this.createdById, paymentMethod.createdById) &&
        Objects.equals(this.createdDate, paymentMethod.createdDate) &&
        Objects.equals(this.creditCardAddress1, paymentMethod.creditCardAddress1) &&
        Objects.equals(this.creditCardAddress2, paymentMethod.creditCardAddress2) &&
        Objects.equals(this.creditCardCity, paymentMethod.creditCardCity) &&
        Objects.equals(this.creditCardCountry, paymentMethod.creditCardCountry) &&
        Objects.equals(this.creditCardExpirationMonth, paymentMethod.creditCardExpirationMonth) &&
        Objects.equals(this.creditCardExpirationYear, paymentMethod.creditCardExpirationYear) &&
        Objects.equals(this.creditCardHolderName, paymentMethod.creditCardHolderName) &&
        Objects.equals(this.creditCardMaskNumber, paymentMethod.creditCardMaskNumber) &&
        Objects.equals(this.creditCardNumber, paymentMethod.creditCardNumber) &&
        Objects.equals(this.creditCardPostalCode, paymentMethod.creditCardPostalCode) &&
        Objects.equals(this.creditCardSecurityCode, paymentMethod.creditCardSecurityCode) &&
        Objects.equals(this.creditCardState, paymentMethod.creditCardState) &&
        Objects.equals(this.creditCardType, paymentMethod.creditCardType) &&
        ...
        Objects.equals(this.firstName, paymentMethod.firstName) &&
        Objects.equals(this.gatewayOptionData, paymentMethod.gatewayOptionData) &&
        Objects.equals(this.IBAN, paymentMethod.IBAN) &&
        Objects.equals(this.iPAddress, paymentMethod.iPAddress) &&
        Objects.equals(this.id, paymentMethod.id) &&
        Objects.equals(this.lastFailedSaleTransactionDate, paymentMethod.lastFailedSaleTransactionDate) &&
        Objects.equals(this.lastName, paymentMethod.lastName) &&
        Objects.equals(this.lastTransactionDateTime, paymentMethod.lastTransactionDateTime) &&
        Objects.equals(this.lastTransactionStatus, paymentMethod.lastTransactionStatus) &&
        Objects.equals(this.mandateCreationDate, paymentMethod.mandateCreationDate) &&
        Objects.equals(this.mandateID, paymentMethod.mandateID) &&
        Objects.equals(this.mandateReceived, paymentMethod.mandateReceived) &&
        Objects.equals(this.mandateUpdateDate, paymentMethod.mandateUpdateDate) &&
        Objects.equals(this.maxConsecutivePaymentFailures, paymentMethod.maxConsecutivePaymentFailures) &&
        Objects.equals(this.name, paymentMethod.name) &&
        Objects.equals(this.numConsecutiveFailures, paymentMethod.numConsecutiveFailures) &&
        Objects.equals(this.paymentMethodStatus, paymentMethod.paymentMethodStatus) &&
        Objects.equals(this.paymentRetryWindow, paymentMethod.paymentRetryWindow) &&
        Objects.equals(this.paypalBaid, paymentMethod.paypalBaid) &&
        Objects.equals(this.paypalEmail, paymentMethod.paypalEmail) &&
        Objects.equals(this.paypalPreapprovalKey, paymentMethod.paypalPreapprovalKey) &&
        Objects.equals(this.paypalType, paymentMethod.paypalType) &&
        Objects.equals(this.phone, paymentMethod.phone) &&
        Objects.equals(this.postalCode, paymentMethod.postalCode) &&
        Objects.equals(this.secondTokenId, paymentMethod.secondTokenId) &&
        Objects.equals(this.skipValidation, paymentMethod.skipValidation) &&
        Objects.equals(this.state, paymentMethod.state) &&
        Objects.equals(this.streetName, paymentMethod.streetName) &&
        Objects.equals(this.streetNumber, paymentMethod.streetNumber) &&
        Objects.equals(this.tokenId, paymentMethod.tokenId) &&
  ...
  public String toString() {
    ...
    sb.append("    creditCardSecurityCode: ").append(toIndentedString(creditCardSecurityCode)).append("\n");
    ...
    sb.append("    gatewayOptionData: ").append(toIndentedString(gatewayOptionData)).append("\n");

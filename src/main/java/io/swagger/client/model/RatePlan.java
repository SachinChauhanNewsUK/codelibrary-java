...
public class RatePlan   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amendmentId, amendmentSubscriptionRatePlanId, amendmentType, createdById, createdDate, name, productRatePlanId, subscriptionId, updatedById, updatedDate);
  }

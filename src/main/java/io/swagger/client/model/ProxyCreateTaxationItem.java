...
public class ProxyCreateTaxationItem   {
  ...
  public ProxyCreateTaxationItem accountingCode(String accountingCode) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem exemptAmount(Double exemptAmount) {
   ...
   * @return exemptAmount
  **/
  @ApiModelProperty(example = "null", required = true, value = " The amount of taxes or VAT for which the customer has an exemption. **Character limit**: 16 **Values**: a decimal value ")
  ...
  public ProxyCreateTaxationItem invoiceItemId(String invoiceItemId) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem jurisdiction(String jurisdiction) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem locationCode(String locationCode) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateTaxationItem taxAmount(Double taxAmount) {
   ...
   * @return taxAmount
  **/
  @ApiModelProperty(example = "null", required = true, value = " The amount of the tax applied to the charge. **Character limit**: 16 **Values**: a decimal value ")
  ...
  public ProxyCreateTaxationItem taxCode(String taxCode) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem taxCodeDescription(String taxCodeDescription) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem taxDate(LocalDate taxDate) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem taxRate(Double taxRate) {
   ...
   * @return taxRate
  **/
  @ApiModelProperty(example = "null", required = true, value = " The tax rate applied to the charge. **Character limit**: 16 **Values**: a valid decimal value ")
  ...
  public ProxyCreateTaxationItem taxRateDescription(String taxRateDescription) {
  ...
  **/
  ...
  public ProxyCreateTaxationItem taxRateType(String taxRateType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyCreateTaxationItem proxyCreateTaxationItem = (ProxyCreateTaxationItem) o;
    return Objects.equals(this.accountingCode, proxyCreateTaxationItem.accountingCode) &&
        Objects.equals(this.exemptAmount, proxyCreateTaxationItem.exemptAmount) &&
        Objects.equals(this.invoiceItemId, proxyCreateTaxationItem.invoiceItemId) &&
        Objects.equals(this.jurisdiction, proxyCreateTaxationItem.jurisdiction) &&
        Objects.equals(this.locationCode, proxyCreateTaxationItem.locationCode) &&
        Objects.equals(this.name, proxyCreateTaxationItem.name) &&
        Objects.equals(this.taxAmount, proxyCreateTaxationItem.taxAmount) &&
        Objects.equals(this.taxCode, proxyCreateTaxationItem.taxCode) &&
        Objects.equals(this.taxCodeDescription, proxyCreateTaxationItem.taxCodeDescription) &&
        Objects.equals(this.taxDate, proxyCreateTaxationItem.taxDate) &&
        Objects.equals(this.taxRate, proxyCreateTaxationItem.taxRate) &&
        Objects.equals(this.taxRateDescription, proxyCreateTaxationItem.taxRateDescription) &&
        Objects.equals(this.taxRateType, proxyCreateTaxationItem.taxRateType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountingCode, exemptAmount, invoiceItemId, jurisdiction, locationCode, name, taxAmount, taxCode, taxCodeDescription, taxDate, taxRate, taxRateDescription, taxRateType);
  }

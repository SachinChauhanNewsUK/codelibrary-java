...
/**
 * API tests for RevenueItemsApi
 */
public class RevenueItemsApiTest {

    private final RevenueItemsApi api = new RevenueItemsApi();
     ...
     */
    @Test
    public void gETRevenueItemsByChargeRevenueEventNumberTest() throws ApiException {
        String eventNumber = null;
        // GETRevenueItemsType response = api.gETRevenueItemsByChargeRevenueEventNumber(eventNumber);
     ...
     */
    @Test
    public void gETRevenueItemsByChargeRevenueSummaryNumberTest() throws ApiException {
        String crsNumber = null;
        // GETRevenueItemsType response = api.gETRevenueItemsByChargeRevenueSummaryNumber(crsNumber);
     ...
     */
    @Test
    public void gETRevenueItemsByRevenueScheduleTest() throws ApiException {
        String rsNumber = null;
        // GETRsRevenueItemsType response = api.gETRevenueItemsByRevenueSchedule(rsNumber);
     ...
     */
    @Test
    public void pUTCustomFieldsonRevenueItemsByRevenueEventTest() throws ApiException {
        String eventNumber = null;
        PUTEventRIDetailType request = null;
        // CommonResponseType response = api.pUTCustomFieldsonRevenueItemsByRevenueEvent(eventNumber, request);
     ...
     */
    @Test
    public void pUTCustomFieldsonRevenueItemsByRevenueScheduleTest() throws ApiException {
        String rsNumber = null;
        PUTScheduleRIDetailType request = null;
        // CommonResponseType response = api.pUTCustomFieldsonRevenueItemsByRevenueSchedule(rsNumber, request);

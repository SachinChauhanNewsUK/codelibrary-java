 ...
 */
@ApiModel(description = "Container for sold-to contact information; uses the same structure as `billToContact`. ")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-31T11:45:12.183-07:00")
public class GETAccountSummaryTypeSoldToContact   {
  ...
  public GETAccountSummaryTypeSoldToContact address1(String address1) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact address2(String address2) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact country(String country) {
   ...
   * @return country
  **/
  @ApiModelProperty(example = "null", value = "[A valid country name or abbreviation](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/J_Country%2C_State%2C_and_Province_Codes/A_Country_Names_and_Their_ISO_Codes). ")
  ...
  public GETAccountSummaryTypeSoldToContact county(String county) {
    this.county = county;
    return this;
  }
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact customFieldC(String customFieldC) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact firstName(String firstName) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "Contact ID. ")
  public String getId() {
    return id;
  }
  ...
  public GETAccountSummaryTypeSoldToContact lastName(String lastName) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact taxRegion(String taxRegion) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact workEmail(String workEmail) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact workPhone(String workPhone) {
  ...
  **/
  ...
  public GETAccountSummaryTypeSoldToContact zipCode(String zipCode) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GETAccountSummaryTypeSoldToContact gETAccountSummaryTypeSoldToContact = (GETAccountSummaryTypeSoldToContact) o;
    return Objects.equals(this.address1, gETAccountSummaryTypeSoldToContact.address1) &&
        Objects.equals(this.address2, gETAccountSummaryTypeSoldToContact.address2) &&
        Objects.equals(this.city, gETAccountSummaryTypeSoldToContact.city) &&
        Objects.equals(this.country, gETAccountSummaryTypeSoldToContact.country) &&
        Objects.equals(this.county, gETAccountSummaryTypeSoldToContact.county) &&
        Objects.equals(this.customFieldC, gETAccountSummaryTypeSoldToContact.customFieldC) &&
        Objects.equals(this.fax, gETAccountSummaryTypeSoldToContact.fax) &&
        Objects.equals(this.firstName, gETAccountSummaryTypeSoldToContact.firstName) &&
        Objects.equals(this.id, gETAccountSummaryTypeSoldToContact.id) &&
        Objects.equals(this.lastName, gETAccountSummaryTypeSoldToContact.lastName) &&
        Objects.equals(this.state, gETAccountSummaryTypeSoldToContact.state) &&
        Objects.equals(this.taxRegion, gETAccountSummaryTypeSoldToContact.taxRegion) &&
        Objects.equals(this.workEmail, gETAccountSummaryTypeSoldToContact.workEmail) &&
        Objects.equals(this.workPhone, gETAccountSummaryTypeSoldToContact.workPhone) &&
        Objects.equals(this.zipCode, gETAccountSummaryTypeSoldToContact.zipCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address1, address2, city, country, county, customFieldC, fax, firstName, id, lastName, state, taxRegion, workEmail, workPhone, zipCode);
  }

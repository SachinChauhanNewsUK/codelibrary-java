...
public class ProxyCreateAmendment   {
  ...
  public ProxyCreateAmendment autoRenew(Boolean autoRenew) {
  ...
  **/
  ...
  public ProxyCreateAmendment contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  ...
  public ProxyCreateAmendment currentTerm(Long currentTerm) {
  ...
  **/
  ...
  public ProxyCreateAmendment currentTermPeriodType(String currentTermPeriodType) {
  ...
  **/
  ...
  public ProxyCreateAmendment customerAcceptanceDate(LocalDate customerAcceptanceDate) {
  ...
  **/
  ...
  public ProxyCreateAmendment description(String description) {
  ...
  **/
  ...
  public ProxyCreateAmendment effectiveDate(LocalDate effectiveDate) {
  ...
  **/
  ...
  public ProxyCreateAmendment name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateAmendment renewalSetting(String renewalSetting) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = " Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed. **Required**: If TermType is Termed **Values**: RENEW_WITH_SPECIFIC_TERM (default), RENEW_TO_EVERGREEN ")
  ...
  public ProxyCreateAmendment renewalTerm(Long renewalTerm) {
  ...
  **/
  ...
  public ProxyCreateAmendment renewalTermPeriodType(String renewalTermPeriodType) {
  ...
  **/
  ...
  public ProxyCreateAmendment serviceActivationDate(LocalDate serviceActivationDate) {
  ...
  **/
  ...
  public ProxyCreateAmendment specificUpdateDate(LocalDate specificUpdateDate) {
  ...
  **/
  ...
  public ProxyCreateAmendment status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateAmendment subscriptionId(String subscriptionId) {
  ...
  **/
  ...
  public ProxyCreateAmendment termStartDate(LocalDate termStartDate) {
  ...
  **/
  ...
  public ProxyCreateAmendment termType(String termType) {
  ...
  **/
  ...
  public ProxyCreateAmendment type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyCreateAmendment proxyCreateAmendment = (ProxyCreateAmendment) o;
    return Objects.equals(this.autoRenew, proxyCreateAmendment.autoRenew) &&
        Objects.equals(this.contractEffectiveDate, proxyCreateAmendment.contractEffectiveDate) &&
        Objects.equals(this.currentTerm, proxyCreateAmendment.currentTerm) &&
        Objects.equals(this.currentTermPeriodType, proxyCreateAmendment.currentTermPeriodType) &&
        Objects.equals(this.customerAcceptanceDate, proxyCreateAmendment.customerAcceptanceDate) &&
        Objects.equals(this.description, proxyCreateAmendment.description) &&
        Objects.equals(this.effectiveDate, proxyCreateAmendment.effectiveDate) &&
        Objects.equals(this.name, proxyCreateAmendment.name) &&
        Objects.equals(this.renewalSetting, proxyCreateAmendment.renewalSetting) &&
        Objects.equals(this.renewalTerm, proxyCreateAmendment.renewalTerm) &&
        Objects.equals(this.renewalTermPeriodType, proxyCreateAmendment.renewalTermPeriodType) &&
        Objects.equals(this.serviceActivationDate, proxyCreateAmendment.serviceActivationDate) &&
        Objects.equals(this.specificUpdateDate, proxyCreateAmendment.specificUpdateDate) &&
        Objects.equals(this.status, proxyCreateAmendment.status) &&
        Objects.equals(this.subscriptionId, proxyCreateAmendment.subscriptionId) &&
        Objects.equals(this.termStartDate, proxyCreateAmendment.termStartDate) &&
        Objects.equals(this.termType, proxyCreateAmendment.termType) &&
        Objects.equals(this.type, proxyCreateAmendment.type);
  }

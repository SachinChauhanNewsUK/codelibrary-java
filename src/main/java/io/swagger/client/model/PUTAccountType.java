...
import io.swagger.client.model.PUTAccountTypeBillToContact;
import io.swagger.client.model.PUTAccountTypeSoldToContact;
...
public class PUTAccountType   {
  ...
  private PUTAccountTypeBillToContact billToContact = null;
  ...
  private PUTAccountTypeSoldToContact soldToContact = null;
  ...
  **/
  ...
  public PUTAccountType customFieldC(String customFieldC) {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "Account name, up to 255 characters. ")
  ...
  **/
  ...
  public PUTAccountType taxInfo(POSTAccountTypeTaxInfo taxInfo) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.autoPay, pUTAccountType.autoPay) &&
        ...
        Objects.equals(this.customFieldC, pUTAccountType.customFieldC) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoPay, batch, billToContact, communicationProfileId, crmId, customFieldC, invoiceTemplateId, name, notes, paymentGateway, soldToContact, tagging, taxInfo);
  }

...
public class PUTRSBasicInfoType   {
  ...
  public PUTRSBasicInfoType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public PUTRSBasicInfoType notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  **/
  ...
  public PUTRSBasicInfoType referenceId(String referenceId) {
   ...
   * @return referenceId
  **/
  @ApiModelProperty(example = "null", value = "Reference ID is used only in the custom unlimited rule to create a revenue schedule. In this scenario, the revenue schedule is not linked to an invoice item or invoice item adjustment.  Use this field only when the revenue schedule is not linked to an invoice item or invoice item adjustment, such as for revenue schedules based on the Custom - Unlimited recognition model.  ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTRSBasicInfoType pUTRSBasicInfoType = (PUTRSBasicInfoType) o;
    return Objects.equals(this.customFieldC, pUTRSBasicInfoType.customFieldC) &&
        Objects.equals(this.notes, pUTRSBasicInfoType.notes) &&
        Objects.equals(this.referenceId, pUTRSBasicInfoType.referenceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customFieldC, notes, referenceId);
  }

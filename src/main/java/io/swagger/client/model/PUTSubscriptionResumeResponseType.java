...
public class PUTSubscriptionResumeResponseType   {
  ...
  public PUTSubscriptionResumeResponseType invoiceId(String invoiceId) {
  ...
  **/
  ...
  public PUTSubscriptionResumeResponseType paidAmount(String paidAmount) {
  ...
  **/
  ...
  public PUTSubscriptionResumeResponseType paymentId(String paymentId) {
  ...
  **/
  ...
  public PUTSubscriptionResumeResponseType resumeDate(LocalDate resumeDate) {
   ...
   * @return resumeDate
  **/
  @ApiModelProperty(example = "null", value = "The date when subscription resumption takes effect, as yyyy-mm-dd. ")
  ...
  public PUTSubscriptionResumeResponseType subscriptionId(String subscriptionId) {
  ...
  **/
  ...
  public PUTSubscriptionResumeResponseType success(Boolean success) {
  ...
  **/
  ...
  public PUTSubscriptionResumeResponseType termEndDate(LocalDate termEndDate) {
   ...
   * @return termEndDate
  **/
  @ApiModelProperty(example = "null", value = "The date when the new subscription term ends, as yyyy-mm-dd. ")
  ...
  public PUTSubscriptionResumeResponseType totalDeltaTcv(String totalDeltaTcv) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTSubscriptionResumeResponseType pUTSubscriptionResumeResponseType = (PUTSubscriptionResumeResponseType) o;
    return Objects.equals(this.invoiceId, pUTSubscriptionResumeResponseType.invoiceId) &&
        Objects.equals(this.paidAmount, pUTSubscriptionResumeResponseType.paidAmount) &&
        Objects.equals(this.paymentId, pUTSubscriptionResumeResponseType.paymentId) &&
        Objects.equals(this.resumeDate, pUTSubscriptionResumeResponseType.resumeDate) &&
        Objects.equals(this.subscriptionId, pUTSubscriptionResumeResponseType.subscriptionId) &&
        Objects.equals(this.success, pUTSubscriptionResumeResponseType.success) &&
        Objects.equals(this.termEndDate, pUTSubscriptionResumeResponseType.termEndDate) &&
        Objects.equals(this.totalDeltaTcv, pUTSubscriptionResumeResponseType.totalDeltaTcv);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoiceId, paidAmount, paymentId, resumeDate, subscriptionId, success, termEndDate, totalDeltaTcv);
  }

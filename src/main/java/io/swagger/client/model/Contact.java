...
public class Contact   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, address1, address2, city, country, county, createdById, createdDate, description, fax, firstName, homePhone, lastName, mobilePhone, nickName, otherPhone, otherPhoneType, personalEmail, postalCode, state, taxRegion, updatedById, updatedDate, workEmail, workPhone);
  }

...
/**
 * API tests for JournalRunsApi
 */
public class JournalRunsApiTest {

    private final JournalRunsApi api = new JournalRunsApi();
     ...
     */
    @Test
    public void dELETEJournalRunTest() throws ApiException {
        String jrNumber = null;
        // CommonResponseType response = api.dELETEJournalRun(jrNumber);
     ...
     */
    @Test
    public void gETJournalRunTest() throws ApiException {
        String jrNumber = null;
        // GETJournalRunType response = api.gETJournalRun(jrNumber);
     ...
     */
    @Test
    public void pOSTJournalRunTest() throws ApiException {
        POSTJournalRunType request = null;
        // POSTJournalRunResponseType response = api.pOSTJournalRun(request);
     ...
     */
    @Test
    public void pUTJournalRunTest() throws ApiException {
        String jrNumber = null;
        // CommonResponseType response = api.pUTJournalRun(jrNumber);

...
/**
 * API tests for SummaryJournalEntriesApi
 */
public class SummaryJournalEntriesApiTest {

    private final SummaryJournalEntriesApi api = new SummaryJournalEntriesApi();
     ...
     */
    @Test
    public void dELETESummaryJournalEntryTest() throws ApiException {
        String jeNumber = null;
        // CommonResponseType response = api.dELETESummaryJournalEntry(jeNumber);
     ...
     */
    @Test
    public void gETJournalEntriesInJournalRunTest() throws ApiException {
        String jrNumber = null;
        // GETJournalEntriesInJournalRunType response = api.gETJournalEntriesInJournalRun(jrNumber);
     ...
     */
    @Test
    public void gETJournalEntryDetailTest() throws ApiException {
        String jeNumber = null;
        // GETJournalEntryDetailType response = api.gETJournalEntryDetail(jeNumber);
     ...
     */
    @Test
    public void pOSTJournalEntryTest() throws ApiException {
        POSTJournalEntryType request = null;
        // POSTJournalEntryResponseType response = api.pOSTJournalEntry(request);
     ...
     */
    @Test
    public void pUTBasicSummaryJournalEntryTest() throws ApiException {
        String jeNumber = null;
        PUTBasicSummaryJournalEntryType request = null;
        // CommonResponseType response = api.pUTBasicSummaryJournalEntry(jeNumber, request);
     ...
     */
    @Test
    public void pUTSummaryJournalEntryTest() throws ApiException {
        String jeNumber = null;
        // CommonResponseType response = api.pUTSummaryJournalEntry(jeNumber);

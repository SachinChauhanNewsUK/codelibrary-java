 ...
 */
@ApiModel(description = "Container for optional sold-to contact; uses the same field structure as the bill-to contact (above). If a sold-to contact is not specified, one is created from the bill-to contact. Once created, these are two separate data entities, and future changes to one do not affect the other. ")
...
public class POSTAccountTypeSoldToContact   {
  ...
  public POSTAccountTypeSoldToContact address1(String address1) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact address2(String address2) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact country(String country) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact county(String county) {
    this.county = county;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact customFieldC(String customFieldC) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact firstName(String firstName) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact homePhone(String homePhone) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact lastName(String lastName) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact mobilePhone(String mobilePhone) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact nickname(String nickname) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact otherPhone(String otherPhone) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact otherPhoneType(String otherPhoneType) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact personalEmail(String personalEmail) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact taxRegion(String taxRegion) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact workEmail(String workEmail) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact workPhone(String workPhone) {
  ...
  **/
  ...
  public POSTAccountTypeSoldToContact zipCode(String zipCode) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTAccountTypeSoldToContact pOSTAccountTypeSoldToContact = (POSTAccountTypeSoldToContact) o;
    return Objects.equals(this.address1, pOSTAccountTypeSoldToContact.address1) &&
        Objects.equals(this.address2, pOSTAccountTypeSoldToContact.address2) &&
        Objects.equals(this.city, pOSTAccountTypeSoldToContact.city) &&
        Objects.equals(this.country, pOSTAccountTypeSoldToContact.country) &&
        Objects.equals(this.county, pOSTAccountTypeSoldToContact.county) &&
        Objects.equals(this.customFieldC, pOSTAccountTypeSoldToContact.customFieldC) &&
        Objects.equals(this.fax, pOSTAccountTypeSoldToContact.fax) &&
        Objects.equals(this.firstName, pOSTAccountTypeSoldToContact.firstName) &&
        Objects.equals(this.homePhone, pOSTAccountTypeSoldToContact.homePhone) &&
        Objects.equals(this.lastName, pOSTAccountTypeSoldToContact.lastName) &&
        Objects.equals(this.mobilePhone, pOSTAccountTypeSoldToContact.mobilePhone) &&
        Objects.equals(this.nickname, pOSTAccountTypeSoldToContact.nickname) &&
        Objects.equals(this.otherPhone, pOSTAccountTypeSoldToContact.otherPhone) &&
        Objects.equals(this.otherPhoneType, pOSTAccountTypeSoldToContact.otherPhoneType) &&
        Objects.equals(this.personalEmail, pOSTAccountTypeSoldToContact.personalEmail) &&
        Objects.equals(this.state, pOSTAccountTypeSoldToContact.state) &&
        Objects.equals(this.taxRegion, pOSTAccountTypeSoldToContact.taxRegion) &&
        Objects.equals(this.workEmail, pOSTAccountTypeSoldToContact.workEmail) &&
        Objects.equals(this.workPhone, pOSTAccountTypeSoldToContact.workPhone) &&
        Objects.equals(this.zipCode, pOSTAccountTypeSoldToContact.zipCode);
  }

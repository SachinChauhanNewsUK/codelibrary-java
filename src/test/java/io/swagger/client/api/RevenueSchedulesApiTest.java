...
/**
 * API tests for RevenueSchedulesApi
 */
public class RevenueSchedulesApiTest {

    private final RevenueSchedulesApi api = new RevenueSchedulesApi();
     ...
     */
    @Test
    public void dELETERSTest() throws ApiException {
        String rsNumber = null;
        // CommonResponseType response = api.dELETERS(rsNumber);
     ...
     */
    @Test
    public void gETRSDetailTest() throws ApiException {
        String rsNumber = null;
        // GETRSDetailType response = api.gETRSDetail(rsNumber);
     ...
     */
    @Test
    public void gETRSDetailsByChargeTest() throws ApiException {
        String chargeKey = null;
        // GETRSDetailsByChargeType response = api.gETRSDetailsByCharge(chargeKey);
     ...
     */
    @Test
    public void gETRSbyInvoiceItemTest() throws ApiException {
        String invoiceItemId = null;
        // GETRSDetailType response = api.gETRSbyInvoiceItem(invoiceItemId);
     ...
     */
    @Test
    public void gETRSbyInvoiceItemAdjustmentTest() throws ApiException {
        String invoiceItemAdjId = null;
        // GETRSDetailType response = api.gETRSbyInvoiceItemAdjustment(invoiceItemAdjId);
     ...
     */
    @Test
    public void pOSTRSforInvoiceItemAdjustmentDistributeByDateRangeTest() throws ApiException {
        String invoiceItemAdjKey = null;
        POSTRevenueScheduleByDateRangeType request = null;
        // POSTRevenueScheduleByTransactionResponseType response = api.pOSTRSforInvoiceItemAdjustmentDistributeByDateRange(invoiceItemAdjKey, request);
     ...
     */
    @Test
    public void pOSTRSforInvoiceItemAdjustmentManualDistributionTest() throws ApiException {
        String invoiceItemAdjKey = null;
        POSTRevenueScheduleByTransactionType request = null;
        // POSTRevenueScheduleByTransactionResponseType response = api.pOSTRSforInvoiceItemAdjustmentManualDistribution(invoiceItemAdjKey, request);
     ...
     */
    @Test
    public void pOSTRSforInvoiceItemDistributeByDateRangeTest() throws ApiException {
        String invoiceItemId = null;
        POSTRevenueScheduleByDateRangeType request = null;
        // POSTRevenueScheduleByTransactionResponseType response = api.pOSTRSforInvoiceItemDistributeByDateRange(invoiceItemId, request);
     ...
     */
    @Test
    public void pOSTRSforInvoiceItemManualDistributionTest() throws ApiException {
        String invoiceItemId = null;
        POSTRevenueScheduleByTransactionType request = null;
        // POSTRevenueScheduleByTransactionResponseType response = api.pOSTRSforInvoiceItemManualDistribution(invoiceItemId, request);
     ...
     */
    @Test
    public void pOSTRevenueScheduleByChargeResponseTest() throws ApiException {
        String chargeKey = null;
        POSTRevenueScheduleByChargeType request = null;
        // POSTRevenueScheduleByChargeResponseType response = api.pOSTRevenueScheduleByChargeResponse(chargeKey, request);
     ...
     */
    @Test
    public void pUTRSBasicInfoTest() throws ApiException {
        String rsNumber = null;
        PUTRSBasicInfoType request = null;
        // CommonResponseType response = api.pUTRSBasicInfo(rsNumber, request);
     ...
     */
    @Test
    public void pUTRevenueAcrossAPTest() throws ApiException {
        String rsNumber = null;
        PUTAllocateManuallyType request = null;
        // PUTRevenueScheduleResponseType response = api.pUTRevenueAcrossAP(rsNumber, request);
     ...
     */
    @Test
    public void pUTRevenueByRecognitionStartandEndDatesTest() throws ApiException {
        String rsNumber = null;
        PUTRSTermType request = null;
        // PUTRevenueScheduleResponseType response = api.pUTRevenueByRecognitionStartandEndDates(rsNumber, request);
     ...
     */
    @Test
    public void pUTRevenueSpecificDateTest() throws ApiException {
        String rsNumber = null;
        PUTSpecificDateAllocationType request = null;
        // PUTRevenueScheduleResponseType response = api.pUTRevenueSpecificDate(rsNumber, request);

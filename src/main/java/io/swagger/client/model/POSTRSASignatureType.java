...
public class POSTRSASignatureType   {
  ...
  **/
   ...
   * @return pageId
  **/
  @ApiModelProperty(example = "null", required = true, value = "The page id of your Payment Pages 2.0 form. Click **Show Page Id** next to the Payment Page name in the Hosted Page List to retrieve the page id. ")
   ...
   * @return uri
  **/
  @ApiModelProperty(example = "null", required = true, value = "The URL that the Payment Page will be served from. Set it to:  * https://www.zuora.com/apps/PublicHostedPageLite.do if you are on the production environment. * https://apisandbox.zuora.com/apps/PublicHostedPageLite.do if you are on the API Sandbox environmentdbox.zuora.com/apps/PublicHostedPageLite.do if you are on the API Sandbox environment. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.method, pOSTRSASignatureType.method) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(method, pageId, uri);
  }

 ...
 */
@ApiModel(description = "Container for the following fields. You must format the `params` field as a JSON object. ")
...
public class POSTMassUpdateTypeParams   {
  ...
  public POSTMassUpdateTypeParams actionType(String actionType) {
   ...
   * @return actionType
  **/
  @ApiModelProperty(example = "null", required = true, value = "Type of mass action you want to perform. The following mass actions are supported: - [UpdateAccountingCode](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Update_Accounting_Codes) - [CreateRevenueSchedule](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Create_Revenue_Schedules) - [UpdateRevenueSchedule](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Update_Revenue_Schedules) - [DeleteRevenueSchedule](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Delete_Revenue_Schedules) - [ImportFXRate](https://knowledgecenter.zuora.com/CC_Finance/Mass_Updater/Import_Foreign_Exchange_Rates) ")
  ...
  public POSTMassUpdateTypeParams checksum(String checksum) {
   ...
   * @return checksum
  **/
  @ApiModelProperty(example = "null", value = "An MD5 checksum that is used to validate the integrity of the uploaded file. The checksum is a 32-character string. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTMassUpdateTypeParams pOSTMassUpdateTypeParams = (POSTMassUpdateTypeParams) o;
    return Objects.equals(this.actionType, pOSTMassUpdateTypeParams.actionType) &&
        Objects.equals(this.checksum, pOSTMassUpdateTypeParams.checksum);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionType, checksum);
  }

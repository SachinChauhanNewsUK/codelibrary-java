...
public class GetFilesApi {
    ...
    private com.squareup.okhttp.Call gETFilesCall(String fileId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/files/{file-id}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "file-id" + "\\}", apiClient.escapeString(fileId.toString()));
     ...
     * @param fileId The Zuora ID of the file you want to retrieve.  See [Get Accounting Period](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Accounting_Periods/Get_Accounting_Period) for getting file IDs of accounting period reports, such as the Revenue Detail report.  (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void gETFiles(String fileId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> gETFilesWithHttpInfo(String fileId) throws ApiException {
        com.squareup.okhttp.Call call = gETFilesCall(fileId, null, null);
     ...
     */
    public com.squareup.okhttp.Call gETFilesAsync(String fileId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = gETFilesCall(fileId, progressListener, progressRequestListener);

...
public class POSTScCreateType   {
  ...
  public POSTScCreateType applyDiscountTo(String applyDiscountTo) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies the type of charges that you want a specific discount to apply to.  Values:  * `ONETIME` * `RECURRING` * `USAGE` * `ONETIMERECURRING` * `ONETIMEUSAGE` * `RECURRINGUSAGE` * `ONETIMERECURRINGUSAGE` ")
  ...
  public POSTScCreateType billCycleDay(String billCycleDay) {
   ...
   * @return billCycleDay
  **/
  @ApiModelProperty(example = "null", value = "Sets the bill cycle day (BCD) for the charge. The BCD determines which day of the month the customer is billed.  Values: `1`-`31` ")
  ...
  public POSTScCreateType billCycleType(String billCycleType) {
  ...
  **/
  ...
  public POSTScCreateType billingPeriod(String billingPeriod) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Billing period for the charge. The start day of the billing period is also called the bill cycle day (BCD).  Values:  * `Month` * `Quarter` * `Semi_Annual` * `Annual` * `Eighteen_Months` * `Two_Years` * `Three_Years` * `Five_Years` * `Specific_Months` * `Subscription_Term` * `Week` * `Specific_Weeks` ")
  ...
  public POSTScCreateType billingPeriodAlignment(String billingPeriodAlignment) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Aligns charges within the same subscription if multiple charges begin on different dates.  Values:  * `AlignToCharge` * `AlignToSubscriptionStart` * `AlignToTermStart` ")
  ...
  public POSTScCreateType billingTiming(String billingTiming) {
  ...
  **/
  ...
  public POSTScCreateType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public POSTScCreateType description(String description) {
  ...
  **/
  ...
  public POSTScCreateType discountAmount(String discountAmount) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies the amount of fixed-amount discount. ")
  ...
  public POSTScCreateType discountLevel(String discountLevel) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies if the discount applies to the product rate plan only, the entire subscription, or to any activity in the account.  Values:  * `rateplan` * `subscription` * `account` ")
  ...
  public POSTScCreateType discountPercentage(String discountPercentage) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Percentage of discount for a percentage discount.  ")
  ...
  public POSTScCreateType endDateCondition(String endDateCondition) {
  ...
  **/
  ...
  public POSTScCreateType includedUnits(String includedUnits) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies the number of units in the base set of units for this charge. Must be >=`0`. ")
  ...
  public POSTScCreateType listPriceBase(String listPriceBase) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The list price base for the product rate plan charge.  Values:  * `Per_Billing_Period` * `Per_Month` * `Per_Week` ")
  ...
  public POSTScCreateType number(String number) {
    this.number = number;
    return this;
  }
   ...
   * @return number
  **/
  @ApiModelProperty(example = "null", value = "Unique number that identifies the charge. Max 50 characters. System-generated if not provided. ")
  ...
  public POSTScCreateType numberOfPeriods(Long numberOfPeriods) {
  ...
  **/
  ...
  public POSTScCreateType overagePrice(String overagePrice) {
   ...
   * @return overagePrice
  **/
  @ApiModelProperty(example = "null", value = "Price for units over the allowed amount. ")
  ...
  public POSTScCreateType overageUnusedUnitsCreditOption(String overageUnusedUnitsCreditOption) {
  ...
  **/
  ...
  public POSTScCreateType price(String price) {
    this.price = price;
    return this;
  }
   ...
   * @return price
  **/
  @ApiModelProperty(example = "null", value = "Price for units in the subscription rate plan. ")
  ...
  public POSTScCreateType priceChangeOption(String priceChangeOption) {
  ...
  **/
  ...
  public POSTScCreateType priceIncreasePercentage(String priceIncreasePercentage) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies the percentage to increase or decrease the price of a termed subscription's renewal. Required if you set the `PriceChangeOption` field to `SpecificPercentageValue`.   Value must be a decimal between `-100` and `100`. ")
  ...
  public POSTScCreateType productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "ID of a product rate-plan charge for this subscription. ")
  ...
  public POSTScCreateType quantity(String quantity) {
   ...
   * @return quantity
  **/
  @ApiModelProperty(example = "null", required = true, value = "Number of units. Must be a decimal >=`0`. ")
  ...
  public POSTScCreateType ratingGroup(String ratingGroup) {
  ...
  **/
  ...
  public POSTScCreateType specificBillingPeriod(Long specificBillingPeriod) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies the number of month or week for the charges billing period. Required if you set the value of the `billingPeriod` field to `Specific_Months` or `Specific_Weeks`. ")
  ...
  public POSTScCreateType specificEndDate(LocalDate specificEndDate) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Defines when the charge ends after the charge trigger date.  **note:**  * This field is only applicable when the `endDateCondition` field is set to `Specific_End_Date`.  * If the subscription ends before the specific end date, the charge ends when the subscription ends. But if the subscription end date is subsequently changed through a Renewal, or Terms and Conditions amendment, the charge will end on the specific end date. ")
  ...
  public POSTScCreateType tiers(List<POSTTierType> tiers) {
    this.tiers = tiers;
    return this;
  }

  public POSTScCreateType addTiersItem(POSTTierType tiersItem) {
  ...
  **/
  ...
  public POSTScCreateType triggerDate(LocalDate triggerDate) {
  ...
  **/
  ...
  public POSTScCreateType triggerEvent(String triggerEvent) {
  ...
  **/
  ...
  public POSTScCreateType unusedUnitsCreditRates(String unusedUnitsCreditRates) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies the rate to credit a customer for unused units of usage. This field applies only for overage charge models when the `OverageUnusedUnitsCreditOption` field is set to `CreditBySpecificRate`. ")
  ...
  public POSTScCreateType upToPeriods(Long upToPeriods) {
  ...
  **/
  ...
  public POSTScCreateType upToPeriodsType(String upToPeriodsType) {
  ...
  **/
  ...
  public POSTScCreateType weeklyBillCycleDay(String weeklyBillCycleDay) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specifies which day of the week is the bill cycle day (BCD) for the charge.   Values:  * `Sunday` * `Monday` * `Tuesday` * `Wednesday` * `Thursday` * `Friday` * `Saturday` ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTScCreateType pOSTScCreateType = (POSTScCreateType) o;
    return Objects.equals(this.applyDiscountTo, pOSTScCreateType.applyDiscountTo) &&
        Objects.equals(this.billCycleDay, pOSTScCreateType.billCycleDay) &&
        Objects.equals(this.billCycleType, pOSTScCreateType.billCycleType) &&
        Objects.equals(this.billingPeriod, pOSTScCreateType.billingPeriod) &&
        Objects.equals(this.billingPeriodAlignment, pOSTScCreateType.billingPeriodAlignment) &&
        Objects.equals(this.billingTiming, pOSTScCreateType.billingTiming) &&
        Objects.equals(this.customFieldC, pOSTScCreateType.customFieldC) &&
        Objects.equals(this.description, pOSTScCreateType.description) &&
        Objects.equals(this.discountAmount, pOSTScCreateType.discountAmount) &&
        Objects.equals(this.discountLevel, pOSTScCreateType.discountLevel) &&
        Objects.equals(this.discountPercentage, pOSTScCreateType.discountPercentage) &&
        Objects.equals(this.endDateCondition, pOSTScCreateType.endDateCondition) &&
        Objects.equals(this.includedUnits, pOSTScCreateType.includedUnits) &&
        Objects.equals(this.listPriceBase, pOSTScCreateType.listPriceBase) &&
        Objects.equals(this.number, pOSTScCreateType.number) &&
        Objects.equals(this.numberOfPeriods, pOSTScCreateType.numberOfPeriods) &&
        Objects.equals(this.overagePrice, pOSTScCreateType.overagePrice) &&
        Objects.equals(this.overageUnusedUnitsCreditOption, pOSTScCreateType.overageUnusedUnitsCreditOption) &&
        Objects.equals(this.price, pOSTScCreateType.price) &&
        Objects.equals(this.priceChangeOption, pOSTScCreateType.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, pOSTScCreateType.priceIncreasePercentage) &&
        Objects.equals(this.productRatePlanChargeId, pOSTScCreateType.productRatePlanChargeId) &&
        Objects.equals(this.quantity, pOSTScCreateType.quantity) &&
        Objects.equals(this.ratingGroup, pOSTScCreateType.ratingGroup) &&
        Objects.equals(this.specificBillingPeriod, pOSTScCreateType.specificBillingPeriod) &&
        Objects.equals(this.specificEndDate, pOSTScCreateType.specificEndDate) &&
        Objects.equals(this.tiers, pOSTScCreateType.tiers) &&
        Objects.equals(this.triggerDate, pOSTScCreateType.triggerDate) &&
        Objects.equals(this.triggerEvent, pOSTScCreateType.triggerEvent) &&
        Objects.equals(this.unusedUnitsCreditRates, pOSTScCreateType.unusedUnitsCreditRates) &&
        Objects.equals(this.upToPeriods, pOSTScCreateType.upToPeriods) &&
        Objects.equals(this.upToPeriodsType, pOSTScCreateType.upToPeriodsType) &&
        Objects.equals(this.weeklyBillCycleDay, pOSTScCreateType.weeklyBillCycleDay);
  }

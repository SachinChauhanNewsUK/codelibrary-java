...
public class ProxyGetAmendment   {
  ...
  public ProxyGetAmendment autoRenew(Boolean autoRenew) {
  ...
  **/
  ...
  public ProxyGetAmendment code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetAmendment contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  ...
  public ProxyGetAmendment createdById(String createdById) {
  ...
  **/
  ...
  public ProxyGetAmendment createdDate(DateTime createdDate) {
  ...
  **/
  ...
  public ProxyGetAmendment currentTerm(Long currentTerm) {
  ...
  **/
  ...
  public ProxyGetAmendment currentTermPeriodType(String currentTermPeriodType) {
  ...
  **/
  ...
  public ProxyGetAmendment customerAcceptanceDate(LocalDate customerAcceptanceDate) {
  ...
  **/
  ...
  public ProxyGetAmendment description(String description) {
  ...
  **/
  ...
  public ProxyGetAmendment effectiveDate(LocalDate effectiveDate) {
  ...
  **/
  ...
  public ProxyGetAmendment id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetAmendment name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetAmendment renewalSetting(String renewalSetting) {
  ...
  **/
  ...
  public ProxyGetAmendment renewalTerm(Long renewalTerm) {
  ...
  **/
  ...
  public ProxyGetAmendment renewalTermPeriodType(String renewalTermPeriodType) {
  ...
  **/
  ...
  public ProxyGetAmendment serviceActivationDate(LocalDate serviceActivationDate) {
  ...
  **/
  ...
  public ProxyGetAmendment specificUpdateDate(LocalDate specificUpdateDate) {
  ...
  **/
  ...
  public ProxyGetAmendment status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetAmendment subscriptionId(String subscriptionId) {
  ...
  **/
  ...
  public ProxyGetAmendment termStartDate(LocalDate termStartDate) {
  ...
  **/
  ...
  public ProxyGetAmendment termType(String termType) {
  ...
  **/
  ...
  public ProxyGetAmendment type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetAmendment updatedById(String updatedById) {
  ...
  **/
  ...
  public ProxyGetAmendment updatedDate(DateTime updatedDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyGetAmendment proxyGetAmendment = (ProxyGetAmendment) o;
    return Objects.equals(this.autoRenew, proxyGetAmendment.autoRenew) &&
        Objects.equals(this.code, proxyGetAmendment.code) &&
        Objects.equals(this.contractEffectiveDate, proxyGetAmendment.contractEffectiveDate) &&
        Objects.equals(this.createdById, proxyGetAmendment.createdById) &&
        Objects.equals(this.createdDate, proxyGetAmendment.createdDate) &&
        Objects.equals(this.currentTerm, proxyGetAmendment.currentTerm) &&
        Objects.equals(this.currentTermPeriodType, proxyGetAmendment.currentTermPeriodType) &&
        Objects.equals(this.customerAcceptanceDate, proxyGetAmendment.customerAcceptanceDate) &&
        Objects.equals(this.description, proxyGetAmendment.description) &&
        Objects.equals(this.effectiveDate, proxyGetAmendment.effectiveDate) &&
        Objects.equals(this.id, proxyGetAmendment.id) &&
        Objects.equals(this.name, proxyGetAmendment.name) &&
        Objects.equals(this.renewalSetting, proxyGetAmendment.renewalSetting) &&
        Objects.equals(this.renewalTerm, proxyGetAmendment.renewalTerm) &&
        Objects.equals(this.renewalTermPeriodType, proxyGetAmendment.renewalTermPeriodType) &&
        Objects.equals(this.serviceActivationDate, proxyGetAmendment.serviceActivationDate) &&
        Objects.equals(this.specificUpdateDate, proxyGetAmendment.specificUpdateDate) &&
        Objects.equals(this.status, proxyGetAmendment.status) &&
        Objects.equals(this.subscriptionId, proxyGetAmendment.subscriptionId) &&
        Objects.equals(this.termStartDate, proxyGetAmendment.termStartDate) &&
        Objects.equals(this.termType, proxyGetAmendment.termType) &&
        Objects.equals(this.type, proxyGetAmendment.type) &&
        Objects.equals(this.updatedById, proxyGetAmendment.updatedById) &&
        Objects.equals(this.updatedDate, proxyGetAmendment.updatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoRenew, code, contractEffectiveDate, createdById, createdDate, currentTerm, currentTermPeriodType, customerAcceptanceDate, description, effectiveDate, id, name, renewalSetting, renewalTerm, renewalTermPeriodType, serviceActivationDate, specificUpdateDate, status, subscriptionId, termStartDate, termType, type, updatedById, updatedDate);
  }

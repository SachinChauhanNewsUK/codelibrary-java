...
public class PUTSrpRemoveType   {
  ...
  public PUTSrpRemoveType contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Effective date of the new subscription, as yyyy-mm-dd. ")
  ...
  public PUTSrpRemoveType customerAcceptanceDate(LocalDate customerAcceptanceDate) {
  ...
  **/
  ...
  public PUTSrpRemoveType ratePlanId(String ratePlanId) {
  ...
  **/
  ...
  public PUTSrpRemoveType serviceActivationDate(LocalDate serviceActivationDate) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The date when the remove amendment is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the `serviceActivationDate` field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTSrpRemoveType pUTSrpRemoveType = (PUTSrpRemoveType) o;
    return Objects.equals(this.contractEffectiveDate, pUTSrpRemoveType.contractEffectiveDate) &&
        Objects.equals(this.customerAcceptanceDate, pUTSrpRemoveType.customerAcceptanceDate) &&
        Objects.equals(this.ratePlanId, pUTSrpRemoveType.ratePlanId) &&
        Objects.equals(this.serviceActivationDate, pUTSrpRemoveType.serviceActivationDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contractEffectiveDate, customerAcceptanceDate, ratePlanId, serviceActivationDate);
  }

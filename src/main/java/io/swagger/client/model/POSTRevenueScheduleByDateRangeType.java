...
import io.swagger.client.model.POSTRevenueScheduleByDateRangeTypeRevenueEvent;
...
public class POSTRevenueScheduleByDateRangeType   {
  ...
  private POSTRevenueScheduleByDateRangeTypeRevenueEvent revenueEvent = null;

  public POSTRevenueScheduleByDateRangeType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public POSTRevenueScheduleByDateRangeType distributionType(String distributionType) {
  ...
  **/
  ...
  public POSTRevenueScheduleByDateRangeType notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  **/
  ...
  public POSTRevenueScheduleByDateRangeType recognitionEnd(LocalDate recognitionEnd) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "The end date of a recognition period in `YYYY-MM-DD` format.   The maximum difference of the `recognitionStart` and `recognitionEnd` date fields is equal to 250 multiplied by the length of an accounting period. ")
  ...
  public POSTRevenueScheduleByDateRangeType recognitionStart(LocalDate recognitionStart) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "The start date of a recognition period in `YYYY-MM-DD` format.  If there is a closed accounting period between the `recognitionStart` and `recognitionEnd` dates, the revenue that would be placed in the closed accounting period is instead placed in the next open accounting period. ")
  ...
  public POSTRevenueScheduleByDateRangeType revenueEvent(POSTRevenueScheduleByDateRangeTypeRevenueEvent revenueEvent) {
  ...
  **/
  ...
  public POSTRevenueScheduleByDateRangeTypeRevenueEvent getRevenueEvent() {
    return revenueEvent;
  }

  public void setRevenueEvent(POSTRevenueScheduleByDateRangeTypeRevenueEvent revenueEvent) {
    this.revenueEvent = revenueEvent;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTRevenueScheduleByDateRangeType pOSTRevenueScheduleByDateRangeType = (POSTRevenueScheduleByDateRangeType) o;
    return Objects.equals(this.customFieldC, pOSTRevenueScheduleByDateRangeType.customFieldC) &&
        Objects.equals(this.distributionType, pOSTRevenueScheduleByDateRangeType.distributionType) &&
        Objects.equals(this.notes, pOSTRevenueScheduleByDateRangeType.notes) &&
        Objects.equals(this.recognitionEnd, pOSTRevenueScheduleByDateRangeType.recognitionEnd) &&
        Objects.equals(this.recognitionStart, pOSTRevenueScheduleByDateRangeType.recognitionStart) &&
        Objects.equals(this.revenueEvent, pOSTRevenueScheduleByDateRangeType.revenueEvent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customFieldC, distributionType, notes, recognitionEnd, recognitionStart, revenueEvent);
  }

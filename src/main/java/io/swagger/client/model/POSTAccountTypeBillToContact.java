 ...
 */
@ApiModel(description = "Container for bill-to contact information for this account. If you do not provide a sold-to contact, the bill-to contact is copied to sold-to contact. Once the sold-to contact is created, changes to billToContact will not affect soldToContact and vice versa. ")
...
public class POSTAccountTypeBillToContact   {
  ...
  public POSTAccountTypeBillToContact address1(String address1) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact address2(String address2) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeBillToContact country(String country) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact county(String county) {
    this.county = county;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeBillToContact customFieldC(String customFieldC) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeBillToContact firstName(String firstName) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact homePhone(String homePhone) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact lastName(String lastName) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact mobilePhone(String mobilePhone) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact nickname(String nickname) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact otherPhone(String otherPhone) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact otherPhoneType(String otherPhoneType) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact personalEmail(String personalEmail) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public POSTAccountTypeBillToContact taxRegion(String taxRegion) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact workEmail(String workEmail) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact workPhone(String workPhone) {
  ...
  **/
  ...
  public POSTAccountTypeBillToContact zipCode(String zipCode) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTAccountTypeBillToContact pOSTAccountTypeBillToContact = (POSTAccountTypeBillToContact) o;
    return Objects.equals(this.address1, pOSTAccountTypeBillToContact.address1) &&
        Objects.equals(this.address2, pOSTAccountTypeBillToContact.address2) &&
        Objects.equals(this.city, pOSTAccountTypeBillToContact.city) &&
        Objects.equals(this.country, pOSTAccountTypeBillToContact.country) &&
        Objects.equals(this.county, pOSTAccountTypeBillToContact.county) &&
        Objects.equals(this.customFieldC, pOSTAccountTypeBillToContact.customFieldC) &&
        Objects.equals(this.fax, pOSTAccountTypeBillToContact.fax) &&
        Objects.equals(this.firstName, pOSTAccountTypeBillToContact.firstName) &&
        Objects.equals(this.homePhone, pOSTAccountTypeBillToContact.homePhone) &&
        Objects.equals(this.lastName, pOSTAccountTypeBillToContact.lastName) &&
        Objects.equals(this.mobilePhone, pOSTAccountTypeBillToContact.mobilePhone) &&
        Objects.equals(this.nickname, pOSTAccountTypeBillToContact.nickname) &&
        Objects.equals(this.otherPhone, pOSTAccountTypeBillToContact.otherPhone) &&
        Objects.equals(this.otherPhoneType, pOSTAccountTypeBillToContact.otherPhoneType) &&
        Objects.equals(this.personalEmail, pOSTAccountTypeBillToContact.personalEmail) &&
        Objects.equals(this.state, pOSTAccountTypeBillToContact.state) &&
        Objects.equals(this.taxRegion, pOSTAccountTypeBillToContact.taxRegion) &&
        Objects.equals(this.workEmail, pOSTAccountTypeBillToContact.workEmail) &&
        Objects.equals(this.workPhone, pOSTAccountTypeBillToContact.workPhone) &&
        Objects.equals(this.zipCode, pOSTAccountTypeBillToContact.zipCode);
  }

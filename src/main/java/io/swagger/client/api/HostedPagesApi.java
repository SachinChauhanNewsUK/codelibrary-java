...
import io.swagger.client.model.GetHostedPagesType;
...
public class HostedPagesApi {
    private ApiClient apiClient;

    public HostedPagesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public HostedPagesApi(ApiClient apiClient) {
    ...
    /* Build call for getHostedPages */
    private com.squareup.okhttp.Call getHostedPagesCall(String versionNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/hostedpages".replaceAll("\\{format\\}","json");
     ...
     */
    public GetHostedPagesType getHostedPages(String versionNumber) throws ApiException {
        ApiResponse<GetHostedPagesType> resp = getHostedPagesWithHttpInfo(versionNumber);
        return resp.getData();
    }
     ...
     * The hostedpages call returns the Payment Pages configuration metadata, specifically, page ID, page version, payment method type.  The following are the version-specific and general REST requests for Payment Pages:  * The request for Payment Pages 1.0 configuration information: &#x60;GET &lt;BaseURL&gt;/hostedpages?version&#x3D;1&#x60; * The request for Payment Pages 2.0 configuration information: &#x60;GET &lt;BaseURL&gt;/hostedpages?version&#x3D;2&#x60; * The request for all versions of Payment Pages configuration information: &#x60;GET &lt;BaseURL&gt;/hostedpages&#x60;  ## Notes If you do not have the corresponding tenant setting enabled, e.g., the request &#x60;version&#x60; parameter set to 2 with the Payment Pages 2.0 setting disabled, you will receive an error. 
     * @param versionNumber Version of the Payment Pages for which you want to retrieve the configuration information. Specify 1 for Payment Pages 1.0 or 2 for Payment Pages 2.0. If omitted, information for all versions of Payment Pages are returned.  The response also depends on your tenant settings for Payment Pages 1.0 and Payment Pages 2.0. For example, if only the tenant setting for Payment Pages 2.0 is enabled, the response will only contain information for Payment Pages 2.0 forms even when this parameter is omitted.  (optional)
     * @return ApiResponse&lt;GetHostedPagesType&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetHostedPagesType> getHostedPagesWithHttpInfo(String versionNumber) throws ApiException {
        com.squareup.okhttp.Call call = getHostedPagesCall(versionNumber, null, null);
        Type localVarReturnType = new TypeToken<GetHostedPagesType>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Return hosted pages (asynchronously)
     * The hostedpages call returns the Payment Pages configuration metadata, specifically, page ID, page version, payment method type.  The following are the version-specific and general REST requests for Payment Pages:  * The request for Payment Pages 1.0 configuration information: &#x60;GET &lt;BaseURL&gt;/hostedpages?version&#x3D;1&#x60; * The request for Payment Pages 2.0 configuration information: &#x60;GET &lt;BaseURL&gt;/hostedpages?version&#x3D;2&#x60; * The request for all versions of Payment Pages configuration information: &#x60;GET &lt;BaseURL&gt;/hostedpages&#x60;  ## Notes If you do not have the corresponding tenant setting enabled, e.g., the request &#x60;version&#x60; parameter set to 2 with the Payment Pages 2.0 setting disabled, you will receive an error. 
     * @param versionNumber Version of the Payment Pages for which you want to retrieve the configuration information. Specify 1 for Payment Pages 1.0 or 2 for Payment Pages 2.0. If omitted, information for all versions of Payment Pages are returned.  The response also depends on your tenant settings for Payment Pages 1.0 and Payment Pages 2.0. For example, if only the tenant setting for Payment Pages 2.0 is enabled, the response will only contain information for Payment Pages 2.0 forms even when this parameter is omitted.  (optional)
     ...
     */
    public com.squareup.okhttp.Call getHostedPagesAsync(String versionNumber, final ApiCallback<GetHostedPagesType> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getHostedPagesCall(versionNumber, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetHostedPagesType>(){}.getType();

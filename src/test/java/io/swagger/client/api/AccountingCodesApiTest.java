...
/**
 * API tests for AccountingCodesApi
 */
public class AccountingCodesApiTest {

    private final AccountingCodesApi api = new AccountingCodesApi();
     ...
     */
    @Test
    public void dELETEAccountingCodeTest() throws ApiException {
        String acId = null;
        // CommonResponseType response = api.dELETEAccountingCode(acId);
     ...
     */
    @Test
    public void gETAccountingCodeItemTest() throws ApiException {
        String acId = null;
        // GETAccountingCodeItemType response = api.gETAccountingCodeItem(acId);
     ...
     */
    @Test
    public void gETAccountingCodesTest() throws ApiException {
        // GETAccountingCodesType response = api.gETAccountingCodes();
     ...
     */
    @Test
    public void pOSTAccountingCodeTest() throws ApiException {
        POSTAccountingCodeType request = null;
        // POSTAccountingCodeResponseType response = api.pOSTAccountingCode(request);
     ...
     */
    @Test
    public void pUTAccountingCodeTest() throws ApiException {
        String acId = null;
        PUTAccountingCodeType request = null;
        // CommonResponseType response = api.pUTAccountingCode(acId, request);
     ...
     */
    @Test
    public void pUTActivateAccountingCodeTest() throws ApiException {
        String acId = null;
        // CommonResponseType response = api.pUTActivateAccountingCode(acId);
     ...
     */
    @Test
    public void pUTDeactivateAccountingCodeTest() throws ApiException {
        String acId = null;
        // CommonResponseType response = api.pUTDeactivateAccountingCode(acId);
     ...
     */
    @Test
    public void proxyDELETEAccountingCodeTest() throws ApiException {
        String id = null;
        // ProxyDeleteResponse response = api.proxyDELETEAccountingCode(id);
     ...
     */
    @Test
    public void proxyGETAccountingCodeTest() throws ApiException {
        String id = null;
        String fields = null;
        // ProxyGetAccountingCode response = api.proxyGETAccountingCode(id, fields);
     ...
     */
    @Test
    public void proxyPOSTAccountingCodeTest() throws ApiException {
        ProxyCreateAccountingCode createRequest = null;
        // ProxyCreateOrModifyResponse response = api.proxyPOSTAccountingCode(createRequest);
     ...
     */
    @Test
    public void proxyPUTAccountingCodeTest() throws ApiException {
        String id = null;
        ProxyModifyAccountingCode modifyRequest = null;
        // ProxyCreateOrModifyResponse response = api.proxyPUTAccountingCode(id, modifyRequest);

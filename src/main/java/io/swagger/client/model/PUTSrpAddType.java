...
import io.swagger.client.model.PUTScAddType;
...
public class PUTSrpAddType   {
  ...
  private List<PUTScAddType> chargeOverrides = new ArrayList<PUTScAddType>();
  ...
  public PUTSrpAddType chargeOverrides(List<PUTScAddType> chargeOverrides) {
    this.chargeOverrides = chargeOverrides;
    return this;
  }

  public PUTSrpAddType addChargeOverridesItem(PUTScAddType chargeOverridesItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "This optional container is used to override the quantity of one or more product rate plan charges for this subscription. ")
  ...
  public PUTSrpAddType contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  ...
  public PUTSrpAddType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public PUTSrpAddType customerAcceptanceDate(LocalDate customerAcceptanceDate) {
  ...
  **/
  ...
  public PUTSrpAddType productRatePlanId(String productRatePlanId) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "ID of a product rate plan for this subscription ")
  ...
  public PUTSrpAddType serviceActivationDate(LocalDate serviceActivationDate) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The date when the new product in the subscription is activated in yyyy-mm-dd format.  You must specify a Service Activation date if the Customer Acceptance date is set. If the Customer Acceptance date is not set, the value of the `serviceActivationDate` field defaults to be the Contract Effective Date.  The billing trigger dates must follow this rule:  contractEffectiveDate <= serviceActivationDate <= contractAcceptanceDate ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTSrpAddType pUTSrpAddType = (PUTSrpAddType) o;
    return Objects.equals(this.chargeOverrides, pUTSrpAddType.chargeOverrides) &&
        Objects.equals(this.contractEffectiveDate, pUTSrpAddType.contractEffectiveDate) &&
        Objects.equals(this.customFieldC, pUTSrpAddType.customFieldC) &&
        Objects.equals(this.customerAcceptanceDate, pUTSrpAddType.customerAcceptanceDate) &&
        Objects.equals(this.productRatePlanId, pUTSrpAddType.productRatePlanId) &&
        Objects.equals(this.serviceActivationDate, pUTSrpAddType.serviceActivationDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chargeOverrides, contractEffectiveDate, customFieldC, customerAcceptanceDate, productRatePlanId, serviceActivationDate);
  }

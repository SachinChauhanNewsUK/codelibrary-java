...
public class ProxyModifyInvoice   {
  ...
  public ProxyModifyInvoice status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ProxyModifyInvoice transferredToAccounting(String transferredToAccounting) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyModifyInvoice proxyModifyInvoice = (ProxyModifyInvoice) o;
    return Objects.equals(this.status, proxyModifyInvoice.status) &&
        Objects.equals(this.transferredToAccounting, proxyModifyInvoice.transferredToAccounting);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, transferredToAccounting);
  }

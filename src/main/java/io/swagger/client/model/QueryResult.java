...
public class QueryResult   {
  ...
  private List<ZObject> records = new ArrayList<ZObject>();

  @SerializedName("size")
  private Integer size = null;

  public QueryResult done(Boolean done) {
    this.done = done;
    return this;
  }
  ...
  **/
  ...
  public QueryResult queryLocator(String queryLocator) {
  ...
  **/
  ...
  public QueryResult records(List<ZObject> records) {
    this.records = records;
    return this;
  }

  public QueryResult addRecordsItem(ZObject recordsItem) {
  ...
  **/
  ...
  public void setRecords(List<ZObject> records) {
    this.records = records;
  }

  public QueryResult size(Integer size) {
    this.size = size;
    return this;
  }

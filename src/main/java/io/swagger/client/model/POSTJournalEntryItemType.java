...
public class POSTJournalEntryItemType   {
  ...
  public POSTJournalEntryItemType accountingCodeName(String accountingCodeName) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Name of the accounting code. ")
  ...
  public POSTJournalEntryItemType accountingCodeType(String accountingCodeType) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Accounting code type. The accounting code types are:  * `AccountsReceivable` *  `Cash` *  `OtherAssets` *  `CustomerCashOnAccount ` * `DeferredRevenue` * `SalesTaxPayable` * `OtherLiabilities` * `SalesRevenue` * `SalesDiscounts` * `OtherRevenue`  * `OtherEquity` * `BadDebt`   * `OtherExpenses`  This field is required if accountingCodeName is not unique. ")
  ...
  public POSTJournalEntryItemType amount(String amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "null", required = true, value = "Journal entry item amount in transaction currency. ")
  ...
  public POSTJournalEntryItemType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public POSTJournalEntryItemType homeCurrencyAmount(String homeCurrencyAmount) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Journal entry item amount in home currency.  This field is required if you have set your home currency for foreign currency conversion. Otherwise, do not pass this field. ")
  ...
  public POSTJournalEntryItemType type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTJournalEntryItemType pOSTJournalEntryItemType = (POSTJournalEntryItemType) o;
    return Objects.equals(this.accountingCodeName, pOSTJournalEntryItemType.accountingCodeName) &&
        Objects.equals(this.accountingCodeType, pOSTJournalEntryItemType.accountingCodeType) &&
        Objects.equals(this.amount, pOSTJournalEntryItemType.amount) &&
        Objects.equals(this.customFieldC, pOSTJournalEntryItemType.customFieldC) &&
        Objects.equals(this.homeCurrencyAmount, pOSTJournalEntryItemType.homeCurrencyAmount) &&
        Objects.equals(this.type, pOSTJournalEntryItemType.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountingCodeName, accountingCodeType, amount, customFieldC, homeCurrencyAmount, type);
  }

...
public class ProxyCreateAccountingCode   {
  ...
  public ProxyCreateAccountingCode gLAccountName(String gLAccountName) {
  ...
  **/
  ...
  public ProxyCreateAccountingCode gLAccountNumber(String gLAccountNumber) {
  ...
  **/
  ...
  public ProxyCreateAccountingCode name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = " The name of the accounting code. **Character limit**: 100 **Z-Finance Required:** No ")
  ...
  public ProxyCreateAccountingCode notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateAccountingCode type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = " The accounting code type. Possible values:  - AccountsReceivable - Cash - OtherAssets - CustomerCashOnAccount - DeferredRevenue - SalesTaxPayable - OtherLiabilities - SalesRevenue - SalesDiscounts - OtherRevenue - OtherEquity - BadDebt - OtherExpenses **Character limit**: N/A **Z-Finance Required:** No ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyCreateAccountingCode proxyCreateAccountingCode = (ProxyCreateAccountingCode) o;
    return Objects.equals(this.gLAccountName, proxyCreateAccountingCode.gLAccountName) &&
        Objects.equals(this.gLAccountNumber, proxyCreateAccountingCode.gLAccountNumber) &&
        Objects.equals(this.name, proxyCreateAccountingCode.name) &&
        Objects.equals(this.notes, proxyCreateAccountingCode.notes) &&
        Objects.equals(this.type, proxyCreateAccountingCode.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gLAccountName, gLAccountNumber, name, notes, type);
  }

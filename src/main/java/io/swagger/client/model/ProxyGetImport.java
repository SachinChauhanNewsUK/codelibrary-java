...
public class ProxyGetImport   {
   ...
   * @return createdById
  **/
  @ApiModelProperty(example = "null", value = " The user ID of the person who created the import. **Character limit**: 32 **Values**: automatically generated ")
  ...
  public ProxyGetImport createdDate(DateTime createdDate) {
  ...
  **/
   ...
   * @return importType
  **/
  @ApiModelProperty(example = "null", value = " The type of item imported. **Character limit**: 7 **Values**: Usage ")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of records successfully imported. **Character limit**: **Values**: automatically generated ")
  ...
  **/
  @ApiModelProperty(example = "null", value = " The URL for your import file, which contains your records for upload. When you upload the file, Zuora assigns it to this address. **Character limit**: **Values**: automatic dynamically-generated URL ")
  ...
  **/
  @ApiModelProperty(example = "null", value = " The URL for the import result file, which is a zipped CSV file. **Character limit**: **Values**: automatic dynamically-generated URL ")
  ...
  **/
   ...
   * @return totalCount
  **/
  @ApiModelProperty(example = "null", value = " The number of records in the import file. **Character limit**: **Values**: automatically generated ")
   ...
   * @return updatedById
  **/
  @ApiModelProperty(example = "null", value = " The ID of the user who last updated the import. **Character limit**: 32 **Values**: automatically generated ")
  ...
  public ProxyGetImport updatedDate(DateTime updatedDate) {
   ...
   * @return updatedDate
  **/
  @ApiModelProperty(example = "null", value = " The date when the import was last updated. **Character limi**t: 29 **Values**: automatically generated ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdById, createdDate, id, importType, importedCount, md5, name, originalResourceUrl, resultResourceUrl, status, statusReason, totalCount, updatedById, updatedDate);
  }

...
import io.swagger.client.model.GETProductRatePlanType;
import io.swagger.client.model.GetProductFeatureType;
...
public class GETProductType   {
  ...
  private List<GetProductFeatureType> productFeatures = new ArrayList<GetProductFeatureType>();

  @SerializedName("productRatePlans")
  private List<GETProductRatePlanType> productRatePlans = new ArrayList<GETProductRatePlanType>();
   ...
   * @return category
  **/
  @ApiModelProperty(example = "null", value = "Category of the product. Used by Zuora Quotes Guided Product Selector.  Possible values are:   - Base Products   - Add On Services   - Miscellaneous Products ")
  ...
  public GETProductType customFieldC(String customFieldC) {
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(example = "null", value = "Optional product description. ")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The date when the product expires and cannot be subscribed to anymore, as `yyyy-mm-dd`. ")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The date when the product becomes available and can be subscribed to, as `yyyy-mm-dd`. ")
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "Product name, up to 100 characters. ")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Container for one or more product features. Only available when the following settings are enabled: - The Entitlements feature in your tenant - The [Enable Feature Specification in Product and Subscriptions](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Default_Subscription_Settings#Enable_Feature_Specification_in_Products_and_Subscriptions.3F) setting in Z-Billing Settings ")
  ...
  public GETProductType productRatePlans(List<GETProductRatePlanType> productRatePlans) {
    this.productRatePlans = productRatePlans;
    return this;
  }

  public GETProductType addProductRatePlansItem(GETProductRatePlanType productRatePlansItem) {
    this.productRatePlans.add(productRatePlansItem);
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "Container for one or more product rate plans: ")
  public List<GETProductRatePlanType> getProductRatePlans() {
    return productRatePlans;
  }

  public void setProductRatePlans(List<GETProductRatePlanType> productRatePlans) {
    this.productRatePlans = productRatePlans;
  }
   ...
   * @return sku
  **/
  @ApiModelProperty(example = "null", value = "Unique product SKU, up to 50 characters. ")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.category, gETProductType.category) &&
        Objects.equals(this.customFieldC, gETProductType.customFieldC) &&
        ...
        Objects.equals(this.tags, gETProductType.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, customFieldC, description, effectiveEndDate, effectiveStartDate, id, name, productFeatures, productRatePlans, sku, tags);
  }

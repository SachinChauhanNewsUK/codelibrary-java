...
public class PUTPaymentMethodType   {
  ...
  public PUTPaymentMethodType addressLine1(String addressLine1) {
  ...
  **/
  ...
  public PUTPaymentMethodType addressLine2(String addressLine2) {
  ...
  **/
  ...
  public PUTPaymentMethodType cardHolderName(String cardHolderName) {
  ...
  **/
  ...
  public PUTPaymentMethodType city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public PUTPaymentMethodType country(String country) {
  ...
  **/
  ...
  public PUTPaymentMethodType defaultPaymentMethod(Boolean defaultPaymentMethod) {
  ...
  **/
  ...
  public PUTPaymentMethodType email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public PUTPaymentMethodType expirationMonth(String expirationMonth) {
  ...
  **/
  ...
  public PUTPaymentMethodType expirationYear(String expirationYear) {
  ...
  **/
  ...
  public PUTPaymentMethodType phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  **/
  ...
  public PUTPaymentMethodType securityCode(String securityCode) {
  ...
  **/
  ...
  public PUTPaymentMethodType state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public PUTPaymentMethodType zipCode(String zipCode) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTPaymentMethodType pUTPaymentMethodType = (PUTPaymentMethodType) o;
    return Objects.equals(this.addressLine1, pUTPaymentMethodType.addressLine1) &&
        Objects.equals(this.addressLine2, pUTPaymentMethodType.addressLine2) &&
        Objects.equals(this.cardHolderName, pUTPaymentMethodType.cardHolderName) &&
        Objects.equals(this.city, pUTPaymentMethodType.city) &&
        Objects.equals(this.country, pUTPaymentMethodType.country) &&
        Objects.equals(this.defaultPaymentMethod, pUTPaymentMethodType.defaultPaymentMethod) &&
        Objects.equals(this.email, pUTPaymentMethodType.email) &&
        Objects.equals(this.expirationMonth, pUTPaymentMethodType.expirationMonth) &&
        Objects.equals(this.expirationYear, pUTPaymentMethodType.expirationYear) &&
        Objects.equals(this.phone, pUTPaymentMethodType.phone) &&
        Objects.equals(this.securityCode, pUTPaymentMethodType.securityCode) &&
        Objects.equals(this.state, pUTPaymentMethodType.state) &&
        Objects.equals(this.zipCode, pUTPaymentMethodType.zipCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressLine1, addressLine2, cardHolderName, city, country, defaultPaymentMethod, email, expirationMonth, expirationYear, phone, securityCode, state, zipCode);
  }

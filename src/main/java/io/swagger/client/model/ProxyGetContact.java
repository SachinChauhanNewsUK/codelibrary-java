...
public class ProxyGetContact   {
  ...
  public ProxyGetContact accountId(String accountId) {
  ...
  **/
  ...
  public ProxyGetContact address1(String address1) {
  ...
  **/
  ...
  public ProxyGetContact address2(String address2) {
  ...
  **/
  ...
  public ProxyGetContact city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetContact country(String country) {
  ...
  **/
  ...
  public ProxyGetContact county(String county) {
    this.county = county;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetContact createdById(String createdById) {
  ...
  **/
  ...
  public ProxyGetContact createdDate(DateTime createdDate) {
  ...
  **/
  ...
  public ProxyGetContact description(String description) {
  ...
  **/
  ...
  public ProxyGetContact fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetContact firstName(String firstName) {
  ...
  **/
  ...
  public ProxyGetContact homePhone(String homePhone) {
  ...
  **/
  ...
  public ProxyGetContact id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetContact lastName(String lastName) {
  ...
  **/
  ...
  public ProxyGetContact mobilePhone(String mobilePhone) {
  ...
  **/
  ...
  public ProxyGetContact nickName(String nickName) {
  ...
  **/
  ...
  public ProxyGetContact otherPhone(String otherPhone) {
  ...
  **/
  ...
  public ProxyGetContact otherPhoneType(String otherPhoneType) {
  ...
  **/
  ...
  public ProxyGetContact personalEmail(String personalEmail) {
  ...
  **/
  ...
  public ProxyGetContact postalCode(String postalCode) {
  ...
  **/
  ...
  public ProxyGetContact state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ProxyGetContact taxRegion(String taxRegion) {
  ...
  **/
  ...
  public ProxyGetContact updatedById(String updatedById) {
  ...
  **/
  ...
  public ProxyGetContact updatedDate(DateTime updatedDate) {
  ...
  **/
  ...
  public ProxyGetContact workEmail(String workEmail) {
  ...
  **/
  ...
  public ProxyGetContact workPhone(String workPhone) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyGetContact proxyGetContact = (ProxyGetContact) o;
    return Objects.equals(this.accountId, proxyGetContact.accountId) &&
        Objects.equals(this.address1, proxyGetContact.address1) &&
        Objects.equals(this.address2, proxyGetContact.address2) &&
        Objects.equals(this.city, proxyGetContact.city) &&
        Objects.equals(this.country, proxyGetContact.country) &&
        Objects.equals(this.county, proxyGetContact.county) &&
        Objects.equals(this.createdById, proxyGetContact.createdById) &&
        Objects.equals(this.createdDate, proxyGetContact.createdDate) &&
        Objects.equals(this.description, proxyGetContact.description) &&
        Objects.equals(this.fax, proxyGetContact.fax) &&
        Objects.equals(this.firstName, proxyGetContact.firstName) &&
        Objects.equals(this.homePhone, proxyGetContact.homePhone) &&
        Objects.equals(this.id, proxyGetContact.id) &&
        Objects.equals(this.lastName, proxyGetContact.lastName) &&
        Objects.equals(this.mobilePhone, proxyGetContact.mobilePhone) &&
        Objects.equals(this.nickName, proxyGetContact.nickName) &&
        Objects.equals(this.otherPhone, proxyGetContact.otherPhone) &&
        Objects.equals(this.otherPhoneType, proxyGetContact.otherPhoneType) &&
        Objects.equals(this.personalEmail, proxyGetContact.personalEmail) &&
        Objects.equals(this.postalCode, proxyGetContact.postalCode) &&
        Objects.equals(this.state, proxyGetContact.state) &&
        Objects.equals(this.taxRegion, proxyGetContact.taxRegion) &&
        Objects.equals(this.updatedById, proxyGetContact.updatedById) &&
        Objects.equals(this.updatedDate, proxyGetContact.updatedDate) &&
        Objects.equals(this.workEmail, proxyGetContact.workEmail) &&
        Objects.equals(this.workPhone, proxyGetContact.workPhone);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, address1, address2, city, country, county, createdById, createdDate, description, fax, firstName, homePhone, id, lastName, mobilePhone, nickName, otherPhone, otherPhoneType, personalEmail, postalCode, state, taxRegion, updatedById, updatedDate, workEmail, workPhone);
  }

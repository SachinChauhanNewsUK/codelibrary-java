...
public class NotificationHistoryApiTest {
     ...
     */
    @Test
    public void gETCalloutHistoryVOsTest() throws ApiException {
        DateTime endTime = null;
        DateTime startTime = null;
        String objectId = null;
        Boolean failedOnly = null;
        String eventCategory = null;
        Boolean includeResponseContent = null;
        // GETCalloutHistoryVOsType response = api.gETCalloutHistoryVOs(endTime, startTime, objectId, failedOnly, eventCategory, includeResponseContent);
     ...
     */
    @Test
    public void gETEmailHistoryVOsTest() throws ApiException {
        DateTime endTime = null;
        DateTime startTime = null;
        String objectId = null;
        Boolean failedOnly = null;
        String eventCategory = null;
        // GETEmailHistoryVOsType response = api.gETEmailHistoryVOs(endTime, startTime, objectId, failedOnly, eventCategory);

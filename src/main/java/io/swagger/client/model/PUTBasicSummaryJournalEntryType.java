...
import io.swagger.client.model.PUTJournalEntryItemType;
...
public class PUTBasicSummaryJournalEntryType   {
  ...
  private List<PUTJournalEntryItemType> journalEntryItems = new ArrayList<PUTJournalEntryItemType>();
  ...
  public PUTBasicSummaryJournalEntryType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public PUTBasicSummaryJournalEntryType journalEntryItems(List<PUTJournalEntryItemType> journalEntryItems) {
    this.journalEntryItems = journalEntryItems;
    return this;
  }

  public PUTBasicSummaryJournalEntryType addJournalEntryItemsItem(PUTJournalEntryItemType journalEntryItemsItem) {
  ...
  **/
  ...
  public List<PUTJournalEntryItemType> getJournalEntryItems() {
    return journalEntryItems;
  }

  public void setJournalEntryItems(List<PUTJournalEntryItemType> journalEntryItems) {
    this.journalEntryItems = journalEntryItems;
  }

  public PUTBasicSummaryJournalEntryType notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  **/
  ...
  public PUTBasicSummaryJournalEntryType transferredToAccounting(String transferredToAccounting) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Status shows whether the journal entry has been transferred to an accounting system. The possible values are `No`, `Processing`, `Yes`, `Error`, `Ignore`.    This field cannot be changed after the summary journal entry has been canceled.    **Note:** The Z-Finance ***Override Transferred to Accounting*** permission is required to change `transferredToAccounting` from `Yes` to any other value. See [Z-Finance Roles](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/A_Administrator_Settings/User_Roles/f_Finance_Roles) for more information. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTBasicSummaryJournalEntryType pUTBasicSummaryJournalEntryType = (PUTBasicSummaryJournalEntryType) o;
    return Objects.equals(this.customFieldC, pUTBasicSummaryJournalEntryType.customFieldC) &&
        Objects.equals(this.journalEntryItems, pUTBasicSummaryJournalEntryType.journalEntryItems) &&
        Objects.equals(this.notes, pUTBasicSummaryJournalEntryType.notes) &&
        Objects.equals(this.transferredToAccounting, pUTBasicSummaryJournalEntryType.transferredToAccounting);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customFieldC, journalEntryItems, notes, transferredToAccounting);
  }

...
/**
 * API tests for ChargeRevenueSummariesApi
 */
public class ChargeRevenueSummariesApiTest {

    private final ChargeRevenueSummariesApi api = new ChargeRevenueSummariesApi();
     ...
     */
    @Test
    public void gETCRSByCRSNumberTest() throws ApiException {
        String crsNumber = null;
        // GETChargeRSDetailType response = api.gETCRSByCRSNumber(crsNumber);
     ...
     */
    @Test
    public void gETCRSByChargeIDTest() throws ApiException {
        String chargeKey = null;
        // GETChargeRSDetailType response = api.gETCRSByChargeID(chargeKey);

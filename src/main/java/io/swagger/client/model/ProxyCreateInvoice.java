...
public class ProxyCreateInvoice   {
  ...
  public ProxyCreateInvoice accountId(String accountId) {
  ...
  **/
  ...
  public ProxyCreateInvoice adjustmentAmount(Double adjustmentAmount) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = " The amount of the invoice adjustments associated with the invoice. **Character limi**t: 16 **Values**: a valid currency amount ")
  ...
  public ProxyCreateInvoice body(String body) {
    this.body = body;
    return this;
  }
   ...
   * @return body
  **/
  @ApiModelProperty(example = "null", required = true, value = " Required ")
  ...
  public ProxyCreateInvoice creditBalanceAdjustmentAmount(Double creditBalanceAdjustmentAmount) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = " The currency amount of the adjustment applied to the customer's credit balance. **Character limit**: 16 **Values**: a valid currency amount This field is only available if the [Zuora Global Support](http://support.zuora.com/) to enable this feature.   ")
  ...
  public ProxyCreateInvoice includesOneTime(Boolean includesOneTime) {
  ...
  **/
  ...
  public ProxyCreateInvoice includesRecurring(Boolean includesRecurring) {
  ...
  **/
  ...
  public ProxyCreateInvoice includesUsage(Boolean includesUsage) {
  ...
  **/
  ...
  public ProxyCreateInvoice invoiceDate(LocalDate invoiceDate) {
  ...
  **/
  ...
  public ProxyCreateInvoice paymentAmount(Double paymentAmount) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = " The amount of payments applied to the invoice. **Character limit**: 16 **Value**s: automatically generated ")
  ...
  public ProxyCreateInvoice refundAmount(Double refundAmount) {
   ...
   * @return refundAmount
  **/
  @ApiModelProperty(example = "null", required = true, value = " Specifies the amount of a refund that was applied against an earlier payment on the invoice. **Character limit**: 16 **Values**: automatically generated ")
  ...
  public ProxyCreateInvoice targetDate(LocalDate targetDate) {
  ...
  **/
  ...
  public ProxyCreateInvoice taxAmount(Double taxAmount) {
   ...
   * @return taxAmount
  **/
  @ApiModelProperty(example = "null", required = true, value = " The total amount of the taxes applied to the invoice. **Character limit**: 16 **Values**: automatically generated ")
  ...
  public ProxyCreateInvoice taxExemptAmount(Double taxExemptAmount) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = " The total amount of the invoice that is exempt from taxation. **Character limit**: 16 **Values**: automatically generated ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyCreateInvoice proxyCreateInvoice = (ProxyCreateInvoice) o;
    return Objects.equals(this.accountId, proxyCreateInvoice.accountId) &&
        Objects.equals(this.adjustmentAmount, proxyCreateInvoice.adjustmentAmount) &&
        Objects.equals(this.body, proxyCreateInvoice.body) &&
        Objects.equals(this.creditBalanceAdjustmentAmount, proxyCreateInvoice.creditBalanceAdjustmentAmount) &&
        Objects.equals(this.includesOneTime, proxyCreateInvoice.includesOneTime) &&
        Objects.equals(this.includesRecurring, proxyCreateInvoice.includesRecurring) &&
        Objects.equals(this.includesUsage, proxyCreateInvoice.includesUsage) &&
        Objects.equals(this.invoiceDate, proxyCreateInvoice.invoiceDate) &&
        Objects.equals(this.paymentAmount, proxyCreateInvoice.paymentAmount) &&
        Objects.equals(this.refundAmount, proxyCreateInvoice.refundAmount) &&
        Objects.equals(this.targetDate, proxyCreateInvoice.targetDate) &&
        Objects.equals(this.taxAmount, proxyCreateInvoice.taxAmount) &&
        Objects.equals(this.taxExemptAmount, proxyCreateInvoice.taxExemptAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, adjustmentAmount, body, creditBalanceAdjustmentAmount, includesOneTime, includesRecurring, includesUsage, invoiceDate, paymentAmount, refundAmount, targetDate, taxAmount, taxExemptAmount);
  }

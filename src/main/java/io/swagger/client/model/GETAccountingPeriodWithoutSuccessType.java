...
public class GETAccountingPeriodWithoutSuccessType   {
  ...
  public GETAccountingPeriodWithoutSuccessType createdBy(String createdBy) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType createdOn(DateTime createdOn) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType endDate(LocalDate endDate) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType fileIds(List<GETAccountingPeriodFileIdsType> fileIds) {
    this.fileIds = fileIds;
    return this;
  }

  public GETAccountingPeriodWithoutSuccessType addFileIdsItem(GETAccountingPeriodFileIdsType fileIdsItem) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType fiscalYear(String fiscalYear) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType fiscalQuarter(Long fiscalQuarter) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType runTrialBalanceEnd(DateTime runTrialBalanceEnd) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType runTrialBalanceErrorMessage(String runTrialBalanceErrorMessage) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType runTrialBalanceStart(DateTime runTrialBalanceStart) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType runTrialBalanceStatus(String runTrialBalanceStatus) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType startDate(LocalDate startDate) {
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public GETAccountingPeriodWithoutSuccessType updatedBy(String updatedBy) {
   ...
   * @return updatedBy
  **/
  @ApiModelProperty(example = "null", value = "D of the user who last updated the accounting period. ")
  ...
  public GETAccountingPeriodWithoutSuccessType updatedOn(DateTime updatedOn) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GETAccountingPeriodWithoutSuccessType gETAccountingPeriodWithoutSuccessType = (GETAccountingPeriodWithoutSuccessType) o;
    return Objects.equals(this.createdBy, gETAccountingPeriodWithoutSuccessType.createdBy) &&
        Objects.equals(this.createdOn, gETAccountingPeriodWithoutSuccessType.createdOn) &&
        Objects.equals(this.customFieldC, gETAccountingPeriodWithoutSuccessType.customFieldC) &&
        Objects.equals(this.endDate, gETAccountingPeriodWithoutSuccessType.endDate) &&
        Objects.equals(this.fileIds, gETAccountingPeriodWithoutSuccessType.fileIds) &&
        Objects.equals(this.fiscalYear, gETAccountingPeriodWithoutSuccessType.fiscalYear) &&
        Objects.equals(this.fiscalQuarter, gETAccountingPeriodWithoutSuccessType.fiscalQuarter) &&
        Objects.equals(this.id, gETAccountingPeriodWithoutSuccessType.id) &&
        Objects.equals(this.name, gETAccountingPeriodWithoutSuccessType.name) &&
        Objects.equals(this.notes, gETAccountingPeriodWithoutSuccessType.notes) &&
        Objects.equals(this.runTrialBalanceEnd, gETAccountingPeriodWithoutSuccessType.runTrialBalanceEnd) &&
        Objects.equals(this.runTrialBalanceErrorMessage, gETAccountingPeriodWithoutSuccessType.runTrialBalanceErrorMessage) &&
        Objects.equals(this.runTrialBalanceStart, gETAccountingPeriodWithoutSuccessType.runTrialBalanceStart) &&
        Objects.equals(this.runTrialBalanceStatus, gETAccountingPeriodWithoutSuccessType.runTrialBalanceStatus) &&
        Objects.equals(this.startDate, gETAccountingPeriodWithoutSuccessType.startDate) &&
        Objects.equals(this.status, gETAccountingPeriodWithoutSuccessType.status) &&
        Objects.equals(this.updatedBy, gETAccountingPeriodWithoutSuccessType.updatedBy) &&
        Objects.equals(this.updatedOn, gETAccountingPeriodWithoutSuccessType.updatedOn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdOn, customFieldC, endDate, fileIds, fiscalYear, fiscalQuarter, id, name, notes, runTrialBalanceEnd, runTrialBalanceErrorMessage, runTrialBalanceStart, runTrialBalanceStatus, startDate, status, updatedBy, updatedOn);
  }

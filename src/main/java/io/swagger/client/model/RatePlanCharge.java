...
public class RatePlanCharge   {
  ...
  private Double overagePrice = null;
  ...
  @SerializedName("RolloverBalance")
  private Double rolloverBalance = null;
  ...
  private Double unusedUnitsCreditRates = null;
  ...
  public RatePlanCharge accountingCode(String accountingCode) {
  ...
  **/
  ...
  public RatePlanCharge applyDiscountTo(String applyDiscountTo) {
  ...
  **/
  ...
  public RatePlanCharge billCycleDay(Integer billCycleDay) {
  ...
  **/
  ...
  public RatePlanCharge billCycleType(String billCycleType) {
  ...
  **/
  ...
  public RatePlanCharge billingPeriod(String billingPeriod) {
  ...
  **/
  ...
  public RatePlanCharge billingPeriodAlignment(String billingPeriodAlignment) {
  ...
  **/
  ...
  public RatePlanCharge billingTiming(String billingTiming) {
  ...
  **/
  ...
  public RatePlanCharge chargeModel(String chargeModel) {
  ...
  **/
  ...
  public RatePlanCharge chargeNumber(String chargeNumber) {
  ...
  **/
  ...
  public RatePlanCharge chargeType(String chargeType) {
  ...
  **/
  ...
  public RatePlanCharge chargedThroughDate(LocalDate chargedThroughDate) {
  ...
  **/
  ...
  public RatePlanCharge createdById(String createdById) {
  ...
  **/
  ...
  public RatePlanCharge createdDate(DateTime createdDate) {
  ...
  **/
  ...
  public RatePlanCharge DMRC(Double DMRC) {
    this.DMRC = DMRC;
    return this;
  }
  ...
  **/
  ...
  public RatePlanCharge DTCV(Double DTCV) {
    this.DTCV = DTCV;
    return this;
  }
  ...
  **/
  ...
  public RatePlanCharge description(String description) {
  ...
  **/
  ...
  public RatePlanCharge discountAmount(Double discountAmount) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Specifies the amount of a fixed-amount discount. You can provide a value for this field if the `ChargeModel` field value is `Discount-Fixed Amount`. If this field is included in a query, the query will filter out the rate plans whose `ChargeModel` field is not of a Discount type. You cannot query this field with the following fields in a single query:  - Price - IncludedUnits - DiscountPercentage - OveragePrice **Character limit**: 16 **Values**: a valid currency amount ")
  ...
  public RatePlanCharge discountLevel(String discountLevel) {
  ...
  **/
  ...
  public RatePlanCharge discountPercentage(Double discountPercentage) {
  ...
  **/
  ...
  public RatePlanCharge effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public RatePlanCharge effectiveStartDate(LocalDate effectiveStartDate) {
  ...
  **/
  ...
  public RatePlanCharge endDateCondition(String endDateCondition) {
  ...
  **/
  ...
  public RatePlanCharge includedUnits(Double includedUnits) {
  ...
  **/
  ...
  public RatePlanCharge isLastSegment(Boolean isLastSegment) {
  ...
  **/
  ...
  public RatePlanCharge listPriceBase(String listPriceBase) {
  ...
  **/
  ...
  public RatePlanCharge MRR(Double MRR) {
    this.MRR = MRR;
    return this;
  }
  ...
  **/
  ...
  public RatePlanCharge name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public RatePlanCharge numberOfPeriods(Long numberOfPeriods) {
  ...
  **/
  ...
  public RatePlanCharge originalId(String originalId) {
  ...
  **/
  ...
  public RatePlanCharge overageCalculationOption(String overageCalculationOption) {
  ...
  **/
  ...
  public RatePlanCharge overagePrice(Double overagePrice) {
  ...
  **/
  ...
  public RatePlanCharge overageUnusedUnitsCreditOption(String overageUnusedUnitsCreditOption) {
  ...
  **/
  ...
  public RatePlanCharge price(Double price) {
    this.price = price;
    return this;
  }
  ...
  **/
  ...
  public RatePlanCharge priceChangeOption(String priceChangeOption) {
  ...
  **/
  ...
  public RatePlanCharge priceIncreasePercentage(Double priceIncreasePercentage) {
  ...
  **/
  ...
  public RatePlanCharge processedThroughDate(LocalDate processedThroughDate) {
  ...
  **/
  ...
  public RatePlanCharge productRatePlanChargeId(String productRatePlanChargeId) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " The ID of the product rate plan charge associated with the subscription rate plan charge, **Character limit**: 32 **Values**: inherited from `ProductRatePlanCharge.Id` ")
  ...
  public RatePlanCharge quantity(Double quantity) {
  ...
  **/
  ...
  public RatePlanCharge ratePlanId(String ratePlanId) {
  ...
  **/
  ...
  public RatePlanCharge revRecCode(String revRecCode) {
  ...
  **/
  ...
  public RatePlanCharge revRecTriggerCondition(String revRecTriggerCondition) {
  ...
  **/
  ...
  public RatePlanCharge revenueRecognitionRuleName(String revenueRecognitionRuleName) {
  ...
  **/
  ...
  public RatePlanCharge rolloverBalance(Double rolloverBalance) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Specifies the number of units of measure (UOM) rolled over from previous periods. This field is applicable only to usage charges with overage models. **Character limit**: 16 **Values**: automatically generated **Note**:  - You cannot query or filter this field with other fields in a single query. - To query or filter this field, you must specify and only specify the rate plan charge Id in the condition. - You cannot use this field in the query or filter condition. ")
  public Double getRolloverBalance() {
    return rolloverBalance;
  }

  public void setRolloverBalance(Double rolloverBalance) {
    this.rolloverBalance = rolloverBalance;
  }

  public RatePlanCharge segment(Integer segment) {
  ...
  **/
  ...
  public RatePlanCharge specificBillingPeriod(Long specificBillingPeriod) {
  ...
  **/
  ...
  public RatePlanCharge specificEndDate(LocalDate specificEndDate) {
  ...
  **/
  ...
  public RatePlanCharge TCV(Double TCV) {
    this.TCV = TCV;
    return this;
  }
  ...
  **/
  ...
  public RatePlanCharge triggerDate(LocalDate triggerDate) {
  ...
  **/
  ...
  public RatePlanCharge triggerEvent(String triggerEvent) {
  ...
  **/
  ...
  public RatePlanCharge UOM(String UOM) {
    this.UOM = UOM;
    return this;
  }
  ...
  **/
  ...
  public RatePlanCharge unusedUnitsCreditRates(Double unusedUnitsCreditRates) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Specifies the rate to credit a customer for unused units of usage. This field is applicable only for overage charge models when the `OverageUnusedUnitsCreditOption` field value is CreditBySpecificRate. **Character limit**: 16 **Values**: a valid decimal value ")
  ...
  public RatePlanCharge upToPeriods(Long upToPeriods) {
  ...
  **/
  ...
  public RatePlanCharge upToPeriodsType(String upToPeriodsType) {
  ...
  **/
  ...
  public RatePlanCharge updatedById(String updatedById) {
  ...
  **/
  ...
  public RatePlanCharge updatedDate(DateTime updatedDate) {
  ...
  **/
  ...
  public RatePlanCharge usageRecordRatingOption(String usageRecordRatingOption) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Determines how Zuora processes usage records for per-unit usage charges. **Character limit**: 18 **Values**: automatically generated ")
  ...
  public RatePlanCharge useDiscountSpecificAccountingCode(Boolean useDiscountSpecificAccountingCode) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Determines whether to define a new accounting code for the new discount charge. **Character limit**: 5 **Values**: inherited from `ProductRatePlanCharge.UseDiscountSpecificAccountingCode` ")
  ...
  public RatePlanCharge version(Long version) {
  ...
  **/
  ...
  public RatePlanCharge weeklyBillCycleDay(String weeklyBillCycleDay) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RatePlanCharge ratePlanCharge = (RatePlanCharge) o;
    return Objects.equals(this.accountingCode, ratePlanCharge.accountingCode) &&
        Objects.equals(this.applyDiscountTo, ratePlanCharge.applyDiscountTo) &&
        Objects.equals(this.billCycleDay, ratePlanCharge.billCycleDay) &&
        Objects.equals(this.billCycleType, ratePlanCharge.billCycleType) &&
        Objects.equals(this.billingPeriod, ratePlanCharge.billingPeriod) &&
        Objects.equals(this.billingPeriodAlignment, ratePlanCharge.billingPeriodAlignment) &&
        Objects.equals(this.billingTiming, ratePlanCharge.billingTiming) &&
        Objects.equals(this.chargeModel, ratePlanCharge.chargeModel) &&
        Objects.equals(this.chargeNumber, ratePlanCharge.chargeNumber) &&
        Objects.equals(this.chargeType, ratePlanCharge.chargeType) &&
        Objects.equals(this.chargedThroughDate, ratePlanCharge.chargedThroughDate) &&
        Objects.equals(this.createdById, ratePlanCharge.createdById) &&
        Objects.equals(this.createdDate, ratePlanCharge.createdDate) &&
        Objects.equals(this.DMRC, ratePlanCharge.DMRC) &&
        Objects.equals(this.DTCV, ratePlanCharge.DTCV) &&
        Objects.equals(this.description, ratePlanCharge.description) &&
        Objects.equals(this.discountAmount, ratePlanCharge.discountAmount) &&
        Objects.equals(this.discountLevel, ratePlanCharge.discountLevel) &&
        Objects.equals(this.discountPercentage, ratePlanCharge.discountPercentage) &&
        Objects.equals(this.effectiveEndDate, ratePlanCharge.effectiveEndDate) &&
        Objects.equals(this.effectiveStartDate, ratePlanCharge.effectiveStartDate) &&
        Objects.equals(this.endDateCondition, ratePlanCharge.endDateCondition) &&
        Objects.equals(this.includedUnits, ratePlanCharge.includedUnits) &&
        Objects.equals(this.isLastSegment, ratePlanCharge.isLastSegment) &&
        Objects.equals(this.listPriceBase, ratePlanCharge.listPriceBase) &&
        Objects.equals(this.MRR, ratePlanCharge.MRR) &&
        Objects.equals(this.name, ratePlanCharge.name) &&
        Objects.equals(this.numberOfPeriods, ratePlanCharge.numberOfPeriods) &&
        Objects.equals(this.originalId, ratePlanCharge.originalId) &&
        Objects.equals(this.overageCalculationOption, ratePlanCharge.overageCalculationOption) &&
        Objects.equals(this.overagePrice, ratePlanCharge.overagePrice) &&
        Objects.equals(this.overageUnusedUnitsCreditOption, ratePlanCharge.overageUnusedUnitsCreditOption) &&
        Objects.equals(this.price, ratePlanCharge.price) &&
        Objects.equals(this.priceChangeOption, ratePlanCharge.priceChangeOption) &&
        Objects.equals(this.priceIncreasePercentage, ratePlanCharge.priceIncreasePercentage) &&
        Objects.equals(this.processedThroughDate, ratePlanCharge.processedThroughDate) &&
        Objects.equals(this.productRatePlanChargeId, ratePlanCharge.productRatePlanChargeId) &&
        Objects.equals(this.quantity, ratePlanCharge.quantity) &&
        Objects.equals(this.ratePlanId, ratePlanCharge.ratePlanId) &&
        Objects.equals(this.revRecCode, ratePlanCharge.revRecCode) &&
        Objects.equals(this.revRecTriggerCondition, ratePlanCharge.revRecTriggerCondition) &&
        Objects.equals(this.revenueRecognitionRuleName, ratePlanCharge.revenueRecognitionRuleName) &&
        Objects.equals(this.rolloverBalance, ratePlanCharge.rolloverBalance) &&
        Objects.equals(this.segment, ratePlanCharge.segment) &&
        Objects.equals(this.specificBillingPeriod, ratePlanCharge.specificBillingPeriod) &&
        Objects.equals(this.specificEndDate, ratePlanCharge.specificEndDate) &&
        Objects.equals(this.TCV, ratePlanCharge.TCV) &&
        Objects.equals(this.triggerDate, ratePlanCharge.triggerDate) &&
        Objects.equals(this.triggerEvent, ratePlanCharge.triggerEvent) &&
        Objects.equals(this.UOM, ratePlanCharge.UOM) &&
        Objects.equals(this.unusedUnitsCreditRates, ratePlanCharge.unusedUnitsCreditRates) &&
        Objects.equals(this.upToPeriods, ratePlanCharge.upToPeriods) &&
        Objects.equals(this.upToPeriodsType, ratePlanCharge.upToPeriodsType) &&
        Objects.equals(this.updatedById, ratePlanCharge.updatedById) &&
        Objects.equals(this.updatedDate, ratePlanCharge.updatedDate) &&
        Objects.equals(this.usageRecordRatingOption, ratePlanCharge.usageRecordRatingOption) &&
        Objects.equals(this.useDiscountSpecificAccountingCode, ratePlanCharge.useDiscountSpecificAccountingCode) &&
        Objects.equals(this.version, ratePlanCharge.version) &&
        Objects.equals(this.weeklyBillCycleDay, ratePlanCharge.weeklyBillCycleDay);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountingCode, applyDiscountTo, billCycleDay, billCycleType, billingPeriod, billingPeriodAlignment, billingTiming, chargeModel, chargeNumber, chargeType, chargedThroughDate, createdById, createdDate, DMRC, DTCV, description, discountAmount, discountLevel, discountPercentage, effectiveEndDate, effectiveStartDate, endDateCondition, includedUnits, isLastSegment, listPriceBase, MRR, name, numberOfPeriods, originalId, overageCalculationOption, overagePrice, overageUnusedUnitsCreditOption, price, priceChangeOption, priceIncreasePercentage, processedThroughDate, productRatePlanChargeId, quantity, ratePlanId, revRecCode, revRecTriggerCondition, revenueRecognitionRuleName, rolloverBalance, segment, specificBillingPeriod, specificEndDate, TCV, triggerDate, triggerEvent, UOM, unusedUnitsCreditRates, upToPeriods, upToPeriodsType, updatedById, updatedDate, usageRecordRatingOption, useDiscountSpecificAccountingCode, version, weeklyBillCycleDay);
  }
  ...
  public String toString() {
    ...
    sb.append("    rolloverBalance: ").append(toIndentedString(rolloverBalance)).append("\n");

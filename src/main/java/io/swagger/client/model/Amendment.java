...
public class Amendment   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoRenew, code, contractEffectiveDate, createdById, createdDate, currentTerm, currentTermPeriodType, customerAcceptanceDate, description, destinationAccountId, destinationInvoiceOwnerId, effectiveDate, name, ratePlanData, renewalSetting, renewalTerm, renewalTermPeriodType, serviceActivationDate, specificUpdateDate, status, subscriptionId, termStartDate, termType, type, updatedById, updatedDate);
  }

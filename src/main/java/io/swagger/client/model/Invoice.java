...
public class Invoice   {
  ...
  @SerializedName("BillRunId")
  private String billRunId = null;
  ...
  @SerializedName("RegenerateInvoicePDF")
  private Boolean regenerateInvoicePDF = null;
  ...
  **/
  ...
  public Invoice adjustmentAmount(Double adjustmentAmount) {
  ...
  **/
  ...
  public Invoice amountWithoutTax(Double amountWithoutTax) {
  ...
  **/
   ...
   * @return billRunId
  **/
  @ApiModelProperty(example = "null", value = " The ID of a Bill Run. **Character limit**: 32 **Values**: a BillRun ID ")
  ...
  public Invoice body(String body) {
    this.body = body;
    return this;
  }
  ...
  **/
  ...
  public Invoice creditBalanceAdjustmentAmount(Double creditBalanceAdjustmentAmount) {
  ...
  **/
  ...
  public Invoice lastEmailSentDate(DateTime lastEmailSentDate) {
  ...
  **/
  ...
  public Invoice postedDate(DateTime postedDate) {
  ...
  **/
  ...
  public Invoice refundAmount(Double refundAmount) {
  ...
  **/
  ...
  public Invoice regenerateInvoicePDF(Boolean regenerateInvoicePDF) {
  ...
  **/
  @ApiModelProperty(example = "null", value = " Regenerates a PDF of an invoice that was already generated. Add this field to an `update()` call to regenerate an invoice PDF. Note that when you set the `RegenerateInvoicePDF` field to `true`, you cannot update any other fields in the same `update()` call. Otherwise, you will receive the following `INVALID_VALUE` error: &quot;When field RegenerateInvoicePDF is set to true to regenerate the invoice PDF file, changes on other fields of the invoice are not allowed.&quot; **Character limit**: 5 **Values**: `True`, `False` ")
  public Boolean getRegenerateInvoicePDF() {
    return regenerateInvoicePDF;
  }

  public void setRegenerateInvoicePDF(Boolean regenerateInvoicePDF) {
    this.regenerateInvoicePDF = regenerateInvoicePDF;
  }
  ...
  **/
  ...
  public Invoice taxExemptAmount(Double taxExemptAmount) {
  ...
  **/
  ...
  public Invoice transferredToAccounting(String transferredToAccounting) {
  ...
  **/
  ...
  public Invoice updatedDate(DateTime updatedDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accountId, invoice.accountId) &&
        ...
        Objects.equals(this.body, invoice.body) &&
        ...
        Objects.equals(this.regenerateInvoicePDF, invoice.regenerateInvoicePDF) &&
  ...
  public String toString() {
    ...
    sb.append("    regenerateInvoicePDF: ").append(toIndentedString(regenerateInvoicePDF)).append("\n");

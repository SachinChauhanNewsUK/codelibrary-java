...
/**
 * API tests for RSASignaturesApi
 */
public class RSASignaturesApiTest {

    private final RSASignaturesApi api = new RSASignaturesApi();
     ...
     */
    @Test
    public void pOSTDecryptResponseTest() throws ApiException {
        POSTDecryptionType request = null;
        // POSTDecryptResponseType response = api.pOSTDecryptResponse(request);
     ...
     */
    @Test
    public void pOSTRSASignatureTest() throws ApiException {
        POSTRSASignatureType request = null;
        // POSTRSASignatureResponseType response = api.pOSTRSASignature(request);

 ...
 */
@ApiModel(description = "Container for tax exempt information, used to establish the tax exempt status of a customer account. ")
...
public class POSTAccountTypeTaxInfo   {
  ...
  private String exemptCertificateId = null;

  @SerializedName("exemptCertificateType")
  private String exemptCertificateType = null;

  @SerializedName("exemptDescription")
  private String exemptDescription = null;

  @SerializedName("exemptEffectiveDate")
  private LocalDate exemptEffectiveDate = null;

  @SerializedName("exemptExpirationDate")
  private LocalDate exemptExpirationDate = null;

  @SerializedName("exemptIssuingJurisdiction")
  private String exemptIssuingJurisdiction = null;

  @SerializedName("exemptStatus")
  private String exemptStatus = null;

  public POSTAccountTypeTaxInfo vATId(String vATId) {
    this.vATId = vATId;
    return this;
  }
   ...
   * @return vATId
  **/
  @ApiModelProperty(example = "null", value = "EU Value Added Tax ID.   **Note:** This feature is in Limited Availability. If you wish to have access to the feature, submit a request at [Zuora Global Support](https://support.zuora.com). ")
  ...
  public POSTAccountTypeTaxInfo companyCode(String companyCode) {
  ...
  **/
  ...
  public POSTAccountTypeTaxInfo exemptCertificateId(String exemptCertificateId) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "ID of the customer tax exemption certificate. Requires Z-Tax. ")
  ...
  public POSTAccountTypeTaxInfo exemptCertificateType(String exemptCertificateType) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Type of tax exemption certificate that the customer holds. Requires Z-Tax. ")
  ...
  public POSTAccountTypeTaxInfo exemptDescription(String exemptDescription) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Description of the tax exemption certificate that the customer holds. Requires Z-Tax. ")
  ...
  public POSTAccountTypeTaxInfo exemptEffectiveDate(LocalDate exemptEffectiveDate) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Date when the customer tax exemption starts. Requires Z-Tax.  Format: `yyyy-mm-dd`. Defaults to the current date. ")
  ...
  public POSTAccountTypeTaxInfo exemptExpirationDate(LocalDate exemptExpirationDate) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Date when the customer tax exemption expires. Requires Z-Tax.  Format: `yyyy-mm-dd`. Defaults to the current date. ")
  ...
  public POSTAccountTypeTaxInfo exemptIssuingJurisdiction(String exemptIssuingJurisdiction) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Jurisdiction in which the customer tax exemption certificate was issued. ")
  ...
  public POSTAccountTypeTaxInfo exemptStatus(String exemptStatus) {
   ...
   * @return exemptStatus
  **/
  @ApiModelProperty(example = "null", value = "Status of the account tax exemption. Requires Z-Tax.  Required if you use Z-Tax. This field is unavailable if Z-Tax is not used.  Values: `Yes`, `No`, `pendingVerification`. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTAccountTypeTaxInfo pOSTAccountTypeTaxInfo = (POSTAccountTypeTaxInfo) o;
    return Objects.equals(this.vATId, pOSTAccountTypeTaxInfo.vATId) &&
        Objects.equals(this.companyCode, pOSTAccountTypeTaxInfo.companyCode) &&
        Objects.equals(this.exemptCertificateId, pOSTAccountTypeTaxInfo.exemptCertificateId) &&
        Objects.equals(this.exemptCertificateType, pOSTAccountTypeTaxInfo.exemptCertificateType) &&
        Objects.equals(this.exemptDescription, pOSTAccountTypeTaxInfo.exemptDescription) &&
        Objects.equals(this.exemptEffectiveDate, pOSTAccountTypeTaxInfo.exemptEffectiveDate) &&
        Objects.equals(this.exemptExpirationDate, pOSTAccountTypeTaxInfo.exemptExpirationDate) &&
        Objects.equals(this.exemptIssuingJurisdiction, pOSTAccountTypeTaxInfo.exemptIssuingJurisdiction) &&
        Objects.equals(this.exemptStatus, pOSTAccountTypeTaxInfo.exemptStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vATId, companyCode, exemptCertificateId, exemptCertificateType, exemptDescription, exemptEffectiveDate, exemptExpirationDate, exemptIssuingJurisdiction, exemptStatus);
  }

...
public class ProxyCreateContact   {
  ...
  public ProxyCreateContact accountId(String accountId) {
   ...
   * @return accountId
  **/
  @ApiModelProperty(example = "null", required = true, value = " The Zuora account ID associated with this contact. This field is not required when you use the subscribe() call. This field is required for all other calls. **Character limit: **32 **Values: **[a valid account ID](https://knowledgecenter.zuora.com/DC_Developers/SOAP_API/E1_SOAP_API_Object_Reference/Account#Id) ")
  ...
  public ProxyCreateContact address1(String address1) {
  ...
  **/
  ...
  public ProxyCreateContact address2(String address2) {
  ...
  **/
  ...
  public ProxyCreateContact city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateContact country(String country) {
  ...
  **/
  ...
  public ProxyCreateContact county(String county) {
    this.county = county;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateContact description(String description) {
  ...
  **/
  ...
  public ProxyCreateContact fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateContact firstName(String firstName) {
   ...
   * @return firstName
  **/
  @ApiModelProperty(example = "null", required = true, value = " The contact's first name. **Character limit**: 100 **Values**: a string of the contact's first name ")
  ...
  public ProxyCreateContact homePhone(String homePhone) {
  ...
  **/
  ...
  public ProxyCreateContact lastName(String lastName) {
   ...
   * @return lastName
  **/
  @ApiModelProperty(example = "null", required = true, value = " The contact's last name. **Character limit**: 100 **Values**: a string of 100 characters or fewer ")
  ...
  public ProxyCreateContact mobilePhone(String mobilePhone) {
  ...
  **/
  ...
  public ProxyCreateContact nickName(String nickName) {
  ...
  **/
  ...
  public ProxyCreateContact otherPhone(String otherPhone) {
  ...
  **/
  ...
  public ProxyCreateContact otherPhoneType(String otherPhoneType) {
  ...
  **/
  ...
  public ProxyCreateContact personalEmail(String personalEmail) {
  ...
  **/
  ...
  public ProxyCreateContact postalCode(String postalCode) {
  ...
  **/
  ...
  public ProxyCreateContact state(String state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ProxyCreateContact taxRegion(String taxRegion) {
  ...
  **/
  ...
  public ProxyCreateContact workEmail(String workEmail) {
  ...
  **/
  ...
  public ProxyCreateContact workPhone(String workPhone) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProxyCreateContact proxyCreateContact = (ProxyCreateContact) o;
    return Objects.equals(this.accountId, proxyCreateContact.accountId) &&
        Objects.equals(this.address1, proxyCreateContact.address1) &&
        Objects.equals(this.address2, proxyCreateContact.address2) &&
        Objects.equals(this.city, proxyCreateContact.city) &&
        Objects.equals(this.country, proxyCreateContact.country) &&
        Objects.equals(this.county, proxyCreateContact.county) &&
        Objects.equals(this.description, proxyCreateContact.description) &&
        Objects.equals(this.fax, proxyCreateContact.fax) &&
        Objects.equals(this.firstName, proxyCreateContact.firstName) &&
        Objects.equals(this.homePhone, proxyCreateContact.homePhone) &&
        Objects.equals(this.lastName, proxyCreateContact.lastName) &&
        Objects.equals(this.mobilePhone, proxyCreateContact.mobilePhone) &&
        Objects.equals(this.nickName, proxyCreateContact.nickName) &&
        Objects.equals(this.otherPhone, proxyCreateContact.otherPhone) &&
        Objects.equals(this.otherPhoneType, proxyCreateContact.otherPhoneType) &&
        Objects.equals(this.personalEmail, proxyCreateContact.personalEmail) &&
        Objects.equals(this.postalCode, proxyCreateContact.postalCode) &&
        Objects.equals(this.state, proxyCreateContact.state) &&
        Objects.equals(this.taxRegion, proxyCreateContact.taxRegion) &&
        Objects.equals(this.workEmail, proxyCreateContact.workEmail) &&
        Objects.equals(this.workPhone, proxyCreateContact.workPhone);
  }

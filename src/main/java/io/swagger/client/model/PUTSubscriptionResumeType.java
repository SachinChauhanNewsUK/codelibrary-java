...
public class PUTSubscriptionResumeType   {
  ...
  public PUTSubscriptionResumeType applyCreditBalance(Boolean applyCreditBalance) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType collect(Boolean collect) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType contractEffectiveDate(LocalDate contractEffectiveDate) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The date when the customer notifies you that they want to resume their subscription. ")
  ...
  public PUTSubscriptionResumeType extendsTerm(Boolean extendsTerm) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType invoice(Boolean invoice) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType invoiceCollect(Boolean invoiceCollect) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType invoiceTargetDate(LocalDate invoiceTargetDate) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType resumePeriods(String resumePeriods) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType resumePeriodsType(String resumePeriodsType) {
  ...
  **/
  ...
  public PUTSubscriptionResumeType resumePolicy(String resumePolicy) {
   ...
   * @return resumePolicy
  **/
  @ApiModelProperty(example = "null", required = true, value = "Resume methods. Specify a way to resume a subscription. See [Resume Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Resume_a_Subscription#Resume_Date) for more information.  Values:  * `Today`: The subscription resumption takes effect on today's date.  * `FixedPeriodsFromSuspendDate`: The subscription resumption takes effect after a specified period based on the suspend date. You must specify the `resumePeriods` and `resumePeriodsType` fields to define the period.  * `SpecificDate`: The subscription resumption takes effect on a specific date. You must define the specific date in the `resumeSpecificDate` field.  * `FixedPeriodsFromToday`: The subscription resumption takes effect after a specified period based on the today's date. You must specify the `resumePeriods` and `resumePeriodsType` fields to define the period. ")
  ...
  public PUTSubscriptionResumeType resumeSpecificDate(LocalDate resumeSpecificDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTSubscriptionResumeType pUTSubscriptionResumeType = (PUTSubscriptionResumeType) o;
    return Objects.equals(this.applyCreditBalance, pUTSubscriptionResumeType.applyCreditBalance) &&
        Objects.equals(this.collect, pUTSubscriptionResumeType.collect) &&
        Objects.equals(this.contractEffectiveDate, pUTSubscriptionResumeType.contractEffectiveDate) &&
        Objects.equals(this.extendsTerm, pUTSubscriptionResumeType.extendsTerm) &&
        Objects.equals(this.invoice, pUTSubscriptionResumeType.invoice) &&
        Objects.equals(this.invoiceCollect, pUTSubscriptionResumeType.invoiceCollect) &&
        Objects.equals(this.invoiceTargetDate, pUTSubscriptionResumeType.invoiceTargetDate) &&
        Objects.equals(this.resumePeriods, pUTSubscriptionResumeType.resumePeriods) &&
        Objects.equals(this.resumePeriodsType, pUTSubscriptionResumeType.resumePeriodsType) &&
        Objects.equals(this.resumePolicy, pUTSubscriptionResumeType.resumePolicy) &&
        Objects.equals(this.resumeSpecificDate, pUTSubscriptionResumeType.resumeSpecificDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applyCreditBalance, collect, contractEffectiveDate, extendsTerm, invoice, invoiceCollect, invoiceTargetDate, resumePeriods, resumePeriodsType, resumePolicy, resumeSpecificDate);
  }
